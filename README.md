...
* The “Shopsanity Prices” setting is disabled if “Shopsanity” is set to “0 Items Per Shop”, since it does nothing ([#1561](https://github.com/TestRunnerSRL/OoT-Randomizer/pull/1561))
