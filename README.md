...
* Other changes:
  * Improvements to receiving items, notably: Gameplay is no longer interrupted if you receive a junk item from another player in multiworld. Major items from pots, crates, etc now display above Link's head while the text box is open. (parts of [#2069](https://github.com/OoTRandomizer/OoT-Randomizer/pull/2069))
