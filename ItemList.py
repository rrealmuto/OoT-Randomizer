...
class GetItemId(IntEnum):
    ...
    GI_SOUL_STALFOS = 0x130
    GI_SOUL_OCTOROK = 0x131
    GI_SOUL_WALLMASTER = 0x132
    GI_SOUL_DODONGO = 0x133
    GI_SOUL_KEESE = 0x134
    GI_SOUL_TEKTITE = 0x135
    GI_SOUL_PEAHAT = 0x136
    GI_SOUL_LIZALFOS_AND_DINALFOS = 0x137
    GI_SOUL_GOHMA_LARVAE = 0x138
    GI_SOUL_SHABOM = 0x139
    GI_SOUL_BABY_DODONGO = 0x13A
    GI_SOUL_BIRI_AND_BARI = 0x13B
    GI_SOUL_TAILPASARAN = 0x13C
    GI_SOUL_SKULLTULA = 0x13D
    GI_SOUL_TORCH_SLUG = 0x13E
    GI_SOUL_MOBLIN = 0x13F
    GI_SOUL_ARMOS = 0x140
    GI_SOUL_DEKU_BABA = 0x141
    GI_SOUL_DEKU_SCRUB = 0x142
    GI_SOUL_BUBBLE = 0x143
    GI_SOUL_BEAMOS = 0x144
    GI_SOUL_FLOORMASTER = 0x145
    GI_SOUL_REDEAD_AND_GIBDO = 0x146
    GI_SOUL_SKULLWALLTULA = 0x147
    GI_SOUL_FLARE_DANCER = 0x148
    GI_SOUL_DEAD_HAND = 0x149
    GI_SOUL_SHELL_BLADE = 0x14A
    GI_SOUL_LIKE_LIKE = 0x14B
    GI_SOUL_SPIKE_ENEMY = 0x14C
    GI_SOUL_ANUBIS = 0x14D
    GI_SOUL_IRON_KNUCKLE = 0x14E
    GI_SOUL_SKULL_KID = 0x14F
    GI_SOUL_FLYING_POT = 0x150
    GI_SOUL_FREEZARD = 0x151
    GI_SOUL_STINGER = 0x152
    GI_SOUL_WOLFOS = 0x153
    GI_SOUL_GUAY = 0x154
    GI_SOUL_QUEEN_GOHMA = 0x155
    GI_SOUL_KING_DODONGO = 0x156
    GI_SOUL_BARINADE = 0x157
    GI_SOUL_PHANTOM_GANON = 0x158
    GI_SOUL_VOLVAGIA = 0x159
    GI_SOUL_MORPHA = 0x15A
    GI_SOUL_BONGO_BONGO = 0x15B
    GI_SOUL_TWINROVA = 0x15C
    GI_SOUL_JABU_JABU_TENTACLE = 0x15D
    GI_SOUL_DARK_LINK = 0x15E
    GI_SOUL_REGIONAL_DEKU_TREE = 0x15F
    GI_SOUL_REGIONAL_DODONGOS_CAVERN = 0x160
    GI_SOUL_REGIONAL_JABU = 0x161
    GI_SOUL_REGIONAL_FOREST_TEMPLE = 0x162
    GI_SOUL_REGIONAL_FIRE_TEMPLE = 0x163
    GI_SOUL_REGIONAL_WATER_TEMPLE = 0x164
    GI_SOUL_REGIONAL_SHADOW_TEMPLE = 0x165
    GI_SOUL_REGIONAL_SPIRIT_TEMPLE = 0x166
    GI_SOUL_REGIONAL_BOTW = 0x167
    GI_SOUL_REGIONAL_ICE_CAVERN = 0x168
    GI_SOUL_REGIONAL_GTG = 0x169
    GI_SOUL_REGIONAL_GANONS_CASTLE = 0x16A
    GI_SOUL_REGIONAL_FOREST_AREA = 0x16B
    GI_SOUL_REGIONAL_HYRULE_FIELD = 0x16C
    GI_SOUL_REGIONAL_LAKE_HYLIA = 0x16D
    GI_SOUL_REGIONAL_GERUDO_AREA = 0x16E
    GI_SOUL_REGIONAL_MARKET_AREA = 0x16F
    GI_SOUL_REGIONAL_KAKARIKO_AREA = 0x170
    GI_SOUL_REGIONAL_GORON_AREA = 0x171
    GI_SOUL_REGIONAL_ZORA_AREA = 0x172
    GI_SOUL_REGIONAL_LLR = 0x173
    GI_SOUL_REGIONAL_GROTTOS = 0x174
    GI_FISHING_ROD = 0x175
    GI_FISH_CHILD_6LB = 0x176
    GI_FISH_CHILD_8LB = 0x177
    GI_FISH_CHILD_10LB = 0x178
    GI_FISH_ADULT_10LB = 0x179
    GI_FISH_ADULT_12LB = 0x17A
    GI_FISH_ADULT_16LB = 0x17B
    GI_FISH_LOACH = 0x17C
