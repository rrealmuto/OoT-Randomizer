...
item_table = {
    ...
    'Ocarina A Button':                                ('Item',     True,  0x103, {'ocarina_button': True}),
    'Ocarina C up Button':                             ('Item',     True,  0x104, {'ocarina_button': True}),
    'Ocarina C down Button':                           ('Item',     True,  0x105, {'ocarina_button': True}),
    'Ocarina C left Button':                           ('Item',     True,  0x106, {'ocarina_button': True}),
    'Ocarina C right Button':                          ('Item',     True,  0x107, {'ocarina_button': True}),
