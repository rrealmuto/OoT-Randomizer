...
item_table = {
    ...
    'Triforce of Power':                               ('Item',     True,  0x0104, {'alias': ('Triforce Piece', 1)}),
    'Triforce of Wisdom':                              ('Item',     True,  0x0105, {'alias': ('Triforce Piece', 1)}),
    'Triforce of Courage':                             ('Item',     True,  0x0106, {'alias': ('Triforce Piece', 1)}),
