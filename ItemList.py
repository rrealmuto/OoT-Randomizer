...
item_table = {
    ...
    'Easter Egg (Pink)':                               ('Item',     True,  0xD4, {'alias': ('Triforce Piece', 1), 'progressive': float('Inf')}),
    'Easter Egg (Orange)':                             ('Item',     True,  0xD5, {'alias': ('Triforce Piece', 1), 'progressive': float('Inf')}),
    'Easter Egg (Green)':                              ('Item',     True,  0xD6, {'alias': ('Triforce Piece', 1), 'progressive': float('Inf')}),
    'Easter Egg (Blue)':                               ('Item',     True,  0xD7, {'alias': ('Triforce Piece', 1), 'progressive': float('Inf')}),
