...
item_table = {
    ...
    'Skull Mask':                                      ('Item',     None,  0x0017, {'trade': True}),
    'Spooky Mask':                                     ('Item',     None,  0x0018, {'trade': True}),
    'Keaton Mask':                                     ('Item',     None,  0x001A, {'trade': True}),
    'Bunny Hood':                                      ('Item',     None,  0x001B, {'trade': True}),
    'Mask of Truth':                                   ('Item',     None,  0x001C, {'trade': True}),
    ...
    'Goron Mask':                                      ('Item',     None,  0x0051, None),
    'Zora Mask':                                       ('Item',     None,  0x0052, None),
    'Gerudo Mask':                                     ('Item',     None,  0x0053, None),
    ...
    'Silver Rupee (Dodongos Cavern Staircase)':                 ('SilverRupee', True,  0x00D4, {'progressive': 5}),
    'Silver Rupee (Ice Cavern Spinning Scythe)':                ('SilverRupee', True,  0x00D5, {'progressive': 5}),
    'Silver Rupee (Ice Cavern Push Block)':                     ('SilverRupee', True,  0x00D6, {'progressive': 5}),
    'Silver Rupee (Bottom of the Well Basement)':               ('SilverRupee', True,  0x00D7, {'progressive': 5}),
    'Silver Rupee (Shadow Temple Scythe Shortcut)':             ('SilverRupee', True,  0x00D8, {'progressive': 5}),
    'Silver Rupee (Shadow Temple Invisible Blades)':            ('SilverRupee', True,  0x00D9, {'progressive': 10}),
    'Silver Rupee (Shadow Temple Huge Pit)':                    ('SilverRupee', True,  0x00DA, {'progressive': 5}),
    'Silver Rupee (Shadow Temple Invisible Spikes)':            ('SilverRupee', True,  0x00DB, {'progressive': 10}),
    'Silver Rupee (Gerudo Training Ground Slopes)':             ('SilverRupee', True,  0x00DC, {'progressive': 5}),
    'Silver Rupee (Gerudo Training Ground Lava)':               ('SilverRupee', True,  0x00DD, {'progressive': 6}),
    'Silver Rupee (Gerudo Training Ground Water)':              ('SilverRupee', True,  0x00DE, {'progressive': 5}),
    'Silver Rupee (Spirit Temple Child Early Torches)':         ('SilverRupee', True,  0x00DF, {'progressive': 5}),
    'Silver Rupee (Spirit Temple Adult Boulders)':              ('SilverRupee', True,  0x00E0, {'progressive': 5}),
    'Silver Rupee (Spirit Temple Lobby and Lower Adult)':       ('SilverRupee', True,  0x00E1, {'progressive': 5}),
    'Silver Rupee (Spirit Temple Sun Block)':                   ('SilverRupee', True,  0x00E2, {'progressive': 5}),
    'Silver Rupee (Spirit Temple Adult Climb)':                 ('SilverRupee', True,  0x00E3, {'progressive': 5}),
    'Silver Rupee (Ganons Castle Spirit Trial)':                ('SilverRupee', True,  0x00E4, {'progressive': 5}),
    'Silver Rupee (Ganons Castle Light Trial)':                 ('SilverRupee', True,  0x00E5, {'progressive': 5}),
    'Silver Rupee (Ganons Castle Fire Trial)':                  ('SilverRupee', True,  0x00E6, {'progressive': 5}),
    'Silver Rupee (Ganons Castle Shadow Trial)':                ('SilverRupee', True,  0x00E7, {'progressive': 5}),
    'Silver Rupee (Ganons Castle Water Trial)':                 ('SilverRupee', True,  0x00E8, {'progressive': 5}),
    'Silver Rupee (Ganons Castle Forest Trial)':                ('SilverRupee', True,  0x00E9, {'progressive': 5}),

    'Silver Rupee Pouch (Dodongos Cavern Staircase)':           ('SilverRupee', True,  0x00EA, {'alias': ('Silver Rupee (Dodongos Cavern Staircase)', 10), 'progressive': 1}),
    'Silver Rupee Pouch (Ice Cavern Spinning Scythe)':          ('SilverRupee', True,  0x00EB, {'alias': ('Silver Rupee (Ice Cavern Spinning Scythe)', 10), 'progressive': 1}),
    'Silver Rupee Pouch (Ice Cavern Push Block)':               ('SilverRupee', True,  0x00EC, {'alias': ('Silver Rupee (Ice Cavern Push Block)', 10), 'progressive': 1}),
    'Silver Rupee Pouch (Bottom of the Well Basement)':         ('SilverRupee', True,  0x00ED, {'alias': ('Silver Rupee (Bottom of the Well Basement)', 10), 'progressive': 1}),
    ...
    'Silver Rupee Pouch (Spirit Temple Child Early Torches)':   ('SilverRupee', True,  0x00F5, {'alias': ('Silver Rupee (Spirit Temple Child Early Torches)', 10), 'progressive': 1}),
    'Silver Rupee Pouch (Spirit Temple Adult Boulders)':        ('SilverRupee', True,  0x00F6, {'alias': ('Silver Rupee (Spirit Temple Adult Boulders)', 10), 'progressive': 1}),
    'Silver Rupee Pouch (Spirit Temple Lobby and Lower Adult)': ('SilverRupee', True,  0x00F7, {'alias': ('Silver Rupee (Spirit Temple Lobby and Lower Adult)', 10), 'progressive': 1}),
    'Silver Rupee Pouch (Spirit Temple Sun Block)':             ('SilverRupee', True,  0x00F8, {'alias': ('Silver Rupee (Spirit Temple Sun Block)', 10), 'progressive': 1}),
    'Silver Rupee Pouch (Spirit Temple Adult Climb)':           ('SilverRupee', True,  0x00F9, {'alias': ('Silver Rupee (Spirit Temple Adult Climb)', 10), 'progressive': 1}),
    'Silver Rupee Pouch (Ganons Castle Spirit Trial)':          ('SilverRupee', True,  0x00FA, {'alias': ('Silver Rupee (Ganons Castle Spirit Trial)', 10), 'progressive': 1}),
    'Silver Rupee Pouch (Ganons Castle Light Trial)':           ('SilverRupee', True,  0x00FB, {'alias': ('Silver Rupee (Ganons Castle Light Trial)', 10), 'progressive': 1}),
    'Silver Rupee Pouch (Ganons Castle Fire Trial)':            ('SilverRupee', True,  0x00FC, {'alias': ('Silver Rupee (Ganons Castle Fire Trial)', 10), 'progressive': 1}),
    'Silver Rupee Pouch (Ganons Castle Shadow Trial)':          ('SilverRupee', True,  0x00FD, {'alias': ('Silver Rupee (Ganons Castle Shadow Trial)', 10), 'progressive': 1}),
    'Silver Rupee Pouch (Ganons Castle Water Trial)':           ('SilverRupee', True,  0x00FE, {'alias': ('Silver Rupee (Ganons Castle Water Trial)', 10), 'progressive': 1}),
    'Silver Rupee Pouch (Ganons Castle Forest Trial)':          ('SilverRupee', True,  0x00FF, {'alias': ('Silver Rupee (Ganons Castle Forest Trial)', 10), 'progressive': 1}),

    'Easter Egg (Pink)':                               ('Item',     True,  0x0100, {'alias': ('Triforce Piece', 1), 'progressive': float('Inf')}),
    'Easter Egg (Orange)':                             ('Item',     True,  0x0101, {'alias': ('Triforce Piece', 1), 'progressive': float('Inf')}),
    'Easter Egg (Green)':                              ('Item',     True,  0x0102, {'alias': ('Triforce Piece', 1), 'progressive': float('Inf')}),
    'Easter Egg (Blue)':                               ('Item',     True,  0x0103, {'alias': ('Triforce Piece', 1), 'progressive': float('Inf')}),
    'Triforce of Power':                               ('Item',     True,  0x0104, {'alias': ('Triforce Piece', 1), 'progressive': float('Inf')}),
    'Triforce of Wisdom':                              ('Item',     True,  0x0105, {'alias': ('Triforce Piece', 1), 'progressive': float('Inf')}),
    'Triforce of Courage':                             ('Item',     True,  0x0106, {'alias': ('Triforce Piece', 1), 'progressive': float('Inf')}),
