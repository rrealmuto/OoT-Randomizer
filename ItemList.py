...
item_table = {
    ...
    'Silver Rupee (Dodongos Cavern Staircase)':                 ('SilverRupee', True,  0xD4, {'progressive': 5, 'dungeon': 'Dodongos Cavern'}),
    'Silver Rupee (Ice Cavern Spinning Scythe)':                ('SilverRupee', True,  0xD5, {'progressive': 5, 'dungeon': 'Ice Cavern'}),
    'Silver Rupee (Ice Cavern Push Block)':                     ('SilverRupee', True,  0xD6, {'progressive': 5, 'dungeon': 'Ice Cavern'}),
    'Silver Rupee (Bottom of the Well Basement)':               ('SilverRupee', True,  0xD7, {'progressive': 5, 'dungeon': 'Bottom of the Well'}),
    'Silver Rupee (Shadow Temple Scythe Shortcut)':             ('SilverRupee', True,  0xD8, {'progressive': 5, 'dungeon': 'Shadow Temple'}),
    'Silver Rupee (Shadow Temple Invisible Blades)':            ('SilverRupee', True,  0xD9, {'progressive': 10, 'dungeon': 'Shadow Temple'}),
    'Silver Rupee (Shadow Temple Huge Pit)':                    ('SilverRupee', True,  0xDA, {'progressive': 5, 'dungeon': 'Shadow Temple'}),
    'Silver Rupee (Shadow Temple Invisible Spikes)':            ('SilverRupee', True,  0xDB, {'progressive': 10, 'dungeon': 'Shadow Temple'}),
    'Silver Rupee (Gerudo Training Ground Slopes)':             ('SilverRupee', True,  0xDC, {'progressive': 5, 'dungeon': 'Gerudo Training Ground'}),
    'Silver Rupee (Gerudo Training Ground Lava)':               ('SilverRupee', True,  0xDD, {'progressive': 6, 'dungeon': 'Gerudo Training Ground'}),
    'Silver Rupee (Gerudo Training Ground Water)':              ('SilverRupee', True,  0xDE, {'progressive': 5, 'dungeon': 'Gerudo Training Ground'}),
    'Silver Rupee (Spirit Temple Child Early Torches)':         ('SilverRupee', True,  0xDF, {'progressive': 5, 'dungeon': 'Spirit Temple'}),
    'Silver Rupee (Spirit Temple Adult Boulders)':              ('SilverRupee', True,  0xE0, {'progressive': 5, 'dungeon': 'Spirit Temple'}),
    'Silver Rupee (Spirit Temple Lobby and Lower Adult)':       ('SilverRupee', True,  0xE1, {'progressive': 5, 'dungeon': 'Spirit Temple'}),
    'Silver Rupee (Spirit Temple Sun Block)':                   ('SilverRupee', True,  0xE2, {'progressive': 5, 'dungeon': 'Spirit Temple'}),
    'Silver Rupee (Spirit Temple Adult Climb)':                 ('SilverRupee', True,  0xE3, {'progressive': 5, 'dungeon': 'Spirit Temple'}),
    'Silver Rupee (Ganons Castle Spirit Trial)':                ('SilverRupee', True,  0xE4, {'progressive': 5, 'dungeon': 'Ganons Castle'}),
    'Silver Rupee (Ganons Castle Light Trial)':                 ('SilverRupee', True,  0xE5, {'progressive': 5, 'dungeon': 'Ganons Castle'}),
    'Silver Rupee (Ganons Castle Fire Trial)':                  ('SilverRupee', True,  0xE6, {'progressive': 5, 'dungeon': 'Ganons Castle'}),
    'Silver Rupee (Ganons Castle Shadow Trial)':                ('SilverRupee', True,  0xE7, {'progressive': 5, 'dungeon': 'Ganons Castle'}),
    'Silver Rupee (Ganons Castle Water Trial)':                 ('SilverRupee', True,  0xE8, {'progressive': 5, 'dungeon': 'Ganons Castle'}),
    'Silver Rupee (Ganons Castle Forest Trial)':                ('SilverRupee', True,  0xE9, {'progressive': 5, 'dungeon': 'Ganons Castle'}),

    'Silver Rupee Pouch (Dodongos Cavern Staircase)':           ('SilverRupee', True,  0xEA, {'alias': ('Silver Rupee (Dodongos Cavern Staircase)', 10), 'progressive': 1, 'dungeon': 'Dodongos Cavern'}),
    'Silver Rupee Pouch (Ice Cavern Spinning Scythe)':          ('SilverRupee', True,  0xEB, {'alias': ('Silver Rupee (Ice Cavern Spinning Scythe)', 10), 'progressive': 1, 'dungeon': 'Ice Cavern'}),
    'Silver Rupee Pouch (Ice Cavern Push Block)':               ('SilverRupee', True,  0xEC, {'alias': ('Silver Rupee (Ice Cavern Push Block)', 10), 'progressive': 1, 'dungeon': 'Ice Cavern'}),
    'Silver Rupee Pouch (Bottom of the Well Basement)':         ('SilverRupee', True,  0xED, {'alias': ('Silver Rupee (Bottom of the Well Basement)', 10), 'progressive': 1, 'dungeon': 'Bottom of the Well'}),
    'Silver Rupee Pouch (Shadow Temple Scythe Shortcut)':       ('SilverRupee', True,  0xEE, {'alias': ('Silver Rupee (Shadow Temple Scythe Shortcut)', 10), 'progressive': 1, 'dungeon': 'Shadow Temple'}),
    'Silver Rupee Pouch (Shadow Temple Invisible Blades)':      ('SilverRupee', True,  0xEF, {'alias': ('Silver Rupee (Shadow Temple Invisible Blades)', 10), 'progressive': 1, 'dungeon': 'Shadow Temple'}),
    'Silver Rupee Pouch (Shadow Temple Huge Pit)':              ('SilverRupee', True,  0xF0, {'alias': ('Silver Rupee (Shadow Temple Huge Pit)', 10), 'progressive': 1, 'dungeon': 'Shadow Temple'}),
    'Silver Rupee Pouch (Shadow Temple Invidible Spikes)':      ('SilverRupee', True,  0xF1, {'alias': ('Silver Rupee (Shadow Temple Invidible Spikes)', 10), 'progressive': 1, 'dungeon': 'Shadow Temple'}),
    'Silver Rupee Pouch (Gerudo Training Ground Slopes)':       ('SilverRupee', True,  0xF2, {'alias': ('Silver Rupee (Gerudo Training Ground Slopes)', 10), 'progressive': 1, 'dungeon': 'Gerudo Training Ground'}),
    'Silver Rupee Pouch (Gerudo Training Ground Lava)':         ('SilverRupee', True,  0xF3, {'alias': ('Silver Rupee (Gerudo Training Ground Lava)', 10), 'progressive': 1, 'dungeon': 'Gerudo Training Ground'}),
    'Silver Rupee Pouch (Gerudo Training Ground Water)':        ('SilverRupee', True,  0xF4, {'alias': ('Silver Rupee (Gerudo Training Ground Water)', 10), 'progressive': 1, 'dungeon': 'Gerudo Training Ground'}),
    'Silver Rupee Pouch (Spirit Temple Child Early Torches)':   ('SilverRupee', True,  0xF5, {'alias': ('Silver Rupee (Spirit Temple Child Early Torches)', 10), 'progressive': 1, 'dungeon': 'Spirit Temple'}),
    'Silver Rupee Pouch (Spirit Temple Adult Boulders)':        ('SilverRupee', True,  0xF6, {'alias': ('Silver Rupee (Spirit Temple Adult Boulders)', 10), 'progressive': 1, 'dungeon': 'Spirit Temple'}),
    'Silver Rupee Pouch (Spirit Temple Lobby and Lower Adult)': ('SilverRupee', True,  0xF7, {'alias': ('Silver Rupee (Spirit Temple Lobby and Lower Adult)', 10), 'progressive': 1, 'dungeon': 'Spirit Temple'}),
    'Silver Rupee Pouch (Spirit Temple Sun Block)':             ('SilverRupee', True,  0xF8, {'alias': ('Silver Rupee (Spirit Temple Sun Block)', 10), 'progressive': 1, 'dungeon': 'Spirit Temple'}),
    'Silver Rupee Pouch (Spirit Temple Adult Climb)':           ('SilverRupee', True,  0xF9, {'alias': ('Silver Rupee (Spirit Temple Adult Climb)', 10), 'progressive': 1, 'dungeon': 'Spirit Temple'}),
    'Silver Rupee Pouch (Ganons Castle Spirit Trial)':          ('SilverRupee', True,  0xFA, {'alias': ('Silver Rupee (Ganons Castle Spirit Trial)', 10), 'progressive': 1, 'dungeon': 'Ganons Castle'}),
    'Silver Rupee Pouch (Ganons Castle Light Trial)':           ('SilverRupee', True,  0xFB, {'alias': ('Silver Rupee (Ganons Castle Light Trial)', 10), 'progressive': 1, 'dungeon': 'Ganons Castle'}),
    'Silver Rupee Pouch (Ganons Castle Fire Trial)':            ('SilverRupee', True,  0xFC, {'alias': ('Silver Rupee (Ganons Castle Fire Trial)', 10), 'progressive': 1, 'dungeon': 'Ganons Castle'}),
    'Silver Rupee Pouch (Ganons Castle Shadow Trial)':          ('SilverRupee', True,  0xFD, {'alias': ('Silver Rupee (Ganons Castle Shadow Trial)', 10), 'progressive': 1, 'dungeon': 'Ganons Castle'}),
    'Silver Rupee Pouch (Ganons Castle Water Trial)':           ('SilverRupee', True,  0xFE, {'alias': ('Silver Rupee (Ganons Castle Water Trial)', 10), 'progressive': 1, 'dungeon': 'Ganons Castle'}),
    'Silver Rupee Pouch (Ganons Castle Forest Trial)':          ('SilverRupee', True,  0xFF, {'alias': ('Silver Rupee (Ganons Castle Forest Trial)', 10), 'progressive': 1, 'dungeon': 'Ganons Castle'}),

    'Easter Egg (Pink)':                               ('Item',     True,  0x100, {'alias': ('Triforce Piece', 1), 'progressive': float('Inf')}),
    'Easter Egg (Orange)':                             ('Item',     True,  0x101, {'alias': ('Triforce Piece', 1), 'progressive': float('Inf')}),
    'Easter Egg (Green)':                              ('Item',     True,  0x102, {'alias': ('Triforce Piece', 1), 'progressive': float('Inf')}),
    'Easter Egg (Blue)':                               ('Item',     True,  0x103, {'alias': ('Triforce Piece', 1), 'progressive': float('Inf')}),
    'Triforce of Power':                               ('Item',     True,  0x104, {'alias': ('Triforce Piece', 1), 'progressive': float('Inf')}),
    'Triforce of Wisdom':                              ('Item',     True,  0x105, {'alias': ('Triforce Piece', 1), 'progressive': float('Inf')}),
    'Triforce of Courage':                             ('Item',     True,  0x106, {'alias': ('Triforce Piece', 1), 'progressive': float('Inf')}),
