...
item_table: dict[str, tuple[str, Optional[bool], Optional[int], Optional[dict[str, Any]]]] = {
    ...
    'Minuet of Forest':                                         ('Song',        True,  0x00BB, {'text_id': 0x73, 'song_id': 0x02, 'item_id': 0x5A}),
    'Bolero of Fire':                                           ('Song',        True,  0x00BC, {'text_id': 0x74, 'song_id': 0x03, 'item_id': 0x5B}),
    'Serenade of Water':                                        ('Song',        True,  0x00BD, {'text_id': 0x75, 'song_id': 0x04, 'item_id': 0x5C}),
    'Requiem of Spirit':                                        ('Song',        True,  0x00BE, {'text_id': 0x76, 'song_id': 0x05, 'item_id': 0x5D}),
    'Nocturne of Shadow':                                       ('Song',        True,  0x00BF, {'text_id': 0x77, 'song_id': 0x06, 'item_id': 0x5E}),
    'Prelude of Light':                                         ('Song',        True,  0x00C0, {'text_id': 0x78, 'song_id': 0x07, 'item_id': 0x5F}),
    'Zeldas Lullaby':                                           ('Song',        True,  0x00C1, {'text_id': 0xD4, 'song_id': 0x0A, 'item_id': 0x60}),
    'Eponas Song':                                              ('Song',        True,  0x00C2, {'text_id': 0xD2, 'song_id': 0x09, 'item_id': 0x61}),
    'Sarias Song':                                              ('Song',        True,  0x00C3, {'text_id': 0xD1, 'song_id': 0x08, 'item_id': 0x62}),
    'Suns Song':                                                ('Song',        True,  0x00C4, {'text_id': 0xD3, 'song_id': 0x0B, 'item_id': 0x63}),
    'Song of Time':                                             ('Song',        True,  0x00C5, {'text_id': 0xD5, 'song_id': 0x0C, 'item_id': 0x64}),
    'Song of Storms':                                           ('Song',        True,  0x00C6, {'text_id': 0xD6, 'song_id': 0x0D, 'item_id': 0x65}),
    ...
    'Kokiri Emerald':                                         ('DungeonReward', True,  0x100B, {'stone': True, 'addr2_data': 0x80, 'bit_mask': 0x00040000, 'item_id': 0x6C, 'actor_type': 0x13, 'object_id': 0x00AD}),
    'Goron Ruby':                                             ('DungeonReward', True,  0x100C, {'stone': True, 'addr2_data': 0x81, 'bit_mask': 0x00080000, 'item_id': 0x6D, 'actor_type': 0x14, 'object_id': 0x00AD}),
    'Zora Sapphire':                                          ('DungeonReward', True,  0x100D, {'stone': True, 'addr2_data': 0x82, 'bit_mask': 0x00100000, 'item_id': 0x6E, 'actor_type': 0x15, 'object_id': 0x00AD}),
    'Forest Medallion':                                       ('DungeonReward', True,  0x100F, {'medallion': True, 'addr2_data': 0x3E, 'bit_mask': 0x00000001, 'item_id': 0x66, 'actor_type': 0x0B, 'object_id': 0x00BA}),
    'Fire Medallion':                                         ('DungeonReward', True,  0x1010, {'medallion': True, 'addr2_data': 0x3C, 'bit_mask': 0x00000002, 'item_id': 0x67, 'actor_type': 0x09, 'object_id': 0x00BA}),
    'Water Medallion':                                        ('DungeonReward', True,  0x1011, {'medallion': True, 'addr2_data': 0x3D, 'bit_mask': 0x00000004, 'item_id': 0x68, 'actor_type': 0x0A, 'object_id': 0x00BA}),
    'Spirit Medallion':                                       ('DungeonReward', True,  0x1013, {'medallion': True, 'addr2_data': 0x3F, 'bit_mask': 0x00000008, 'item_id': 0x69, 'actor_type': 0x0C, 'object_id': 0x00BA}),
    'Shadow Medallion':                                       ('DungeonReward', True,  0x1012, {'medallion': True, 'addr2_data': 0x41, 'bit_mask': 0x00000010, 'item_id': 0x6A, 'actor_type': 0x0D, 'object_id': 0x00BA}),
    'Light Medallion':                                        ('DungeonReward', True,  0x100E, {'medallion': True, 'addr2_data': 0x40, 'bit_mask': 0x00000020, 'item_id': 0x6B, 'actor_type': 0x0E, 'object_id': 0x00BA}),
}
