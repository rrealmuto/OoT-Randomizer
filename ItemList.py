...
item_table = {
    ...
    'Triforce of Power':                               ('Item',     True,  0x1004, {'alias': ('Triforce Piece', 1)}),
    'Triforce of Wisdom':                              ('Item',     True,  0x1005, {'alias': ('Triforce Piece', 1)}),
    'Triforce of Courage':                             ('Item',     True,  0x1006, {'alias': ('Triforce Piece', 1)}),
