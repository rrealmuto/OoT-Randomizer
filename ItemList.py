...
item_table: dict[str, tuple[str, Optional[bool], Optional[int], Optional[dict[str, Any]]]] = {
    ...
    'Fish (Child 6 lb)':                               ('Item',     True,  0x2101, None),
    'Fish (Child 8 lb)':                               ('Item',     True,  0x2102, None),
    'Fish (Child 10 lb)':                              ('Item',     True,  0x2103, None),
    'Fish (Adult 10 lb)':                              ('Item',     True,  0x2104, None),
    'Fish (Adult 12 lb)':                              ('Item',     True,  0x2105, None),
    'Fish (Adult 16 lb)':                              ('Item',     True,  0x2106, None),
    'Hylian Loach':                                    ('Item',     True,  0x2107, None),
