...
item_table: dict[str, tuple[str, Optional[bool], Optional[int], Optional[dict[str, Any]]]] = {
    ...
    'Triforce of Power':                               ('Item',     True,  0x0120, {'alias': ('Triforce Piece', 1)}),
    'Triforce of Wisdom':                              ('Item',     True,  0x0121, {'alias': ('Triforce Piece', 1)}),
    'Triforce of Courage':                             ('Item',     True,  0x0122, {'alias': ('Triforce Piece', 1)}),
