...
item_table: dict[str, tuple[str, Optional[bool], Optional[int], Optional[dict[str, Any]]]] = {
    ...
    'Biri Soul': ('Item', True, 0x124, None),
    ...
    'Bari Soul': ('Item', True, 0x12C, None),
    'Bubble Soul': ('Item', True, 0x12D, None),
    'Beamos Soul': ('Item', True, 0x12E, None),
    'Floormaster Soul': ('Item', True, 0x12F, None),
    'Redead and Gibdo Soul': ('Item', True, 0x130, None),
    'Skullwalltula Soul': ('Item', True, 0x131, None),
    'Flare Dancer Soul': ('Item', True, 0x132, None),
    'Dead hand Soul': ('Item', True, 0x133, None),
    'Shell blade Soul': ('Item', True, 0x134, None),
    'Like-like Soul': ('Item', True, 0x135, None),
    'Spike Enemy Soul': ('Item', True, 0x136, None),
    'Anubis Soul': ('Item', True, 0x137, None),
    'Iron Knuckle Soul': ('Item', True, 0x138, None),
    'Skull Kid Soul': ('Item', True, 0x139, None),
    'Flying Pot Soul': ('Item', True, 0x13A, None),
    'Freezard Soul': ('Item', True, 0x13B, None),
    'Stinger Soul': ('Item', True, 0x13C, None),
    'Wolfos Soul': ('Item', True, 0x13D, None),
    'Guay Soul': ('Item', True, 0x13E, None),
