...
item_table: dict[str, tuple[str, Optional[bool], Optional[int], Optional[dict[str, Any]]]] = {
    ...
    'Stalfos Soul':                                    ('Soul',     True,  0x1025, None),
    'Octorok Soul':                                    ('Soul',     True,  0x1026, None),
    'Wallmaster Soul':                                 ('Soul',     True,  0x1027, None),
    'Dodongo Soul':                                    ('Soul',     True,  0x1028, None),
    'Keese Soul':                                      ('Soul',     True,  0x1029, None),
    'Tektite Soul':                                    ('Soul',     True,  0x102A, None),
    'Peahat Soul':                                     ('Soul',     True,  0x102B, None),
    'Lizalfos and Dinalfos Soul':                      ('Soul',     True,  0x102C, None),
    'Gohma Larvae Soul':                               ('Soul',     True,  0x102D, None),
    'Shabom Soul':                                     ('Soul',     True,  0x102E, None),
    'Baby Dodongo Soul':                               ('Soul',     True,  0x102F, None),
    'Biri and Bari Soul':                              ('Soul',     True,  0x1030, None),
    'Tailpasaran Soul':                                ('Soul',     True,  0x1031, None),
    'Skulltula Soul':                                  ('Soul',     True,  0x1032, None),
    'Torch Slug Soul':                                 ('Soul',     True,  0x1033, None),
    'Moblin Soul':                                     ('Soul',     True,  0x1034, None),
    'Armos Soul':                                      ('Soul',     True,  0x1035, None),
    'Deku Baba Soul':                                  ('Soul',     True,  0x1036, None),
    'Deku Scrub Soul':                                 ('Soul',     True,  0x1037, None),
    'Bubble Soul':                                     ('Soul',     True,  0x1038, None),
    'Beamos Soul':                                     ('Soul',     True,  0x1039, None),
    'Floormaster Soul':                                ('Soul',     True,  0x103A, None),
    'Redead and Gibdo Soul':                           ('Soul',     True,  0x103B, None),
    'Skullwalltula Soul':                              ('Soul',     True,  0x103C, None),
    'Flare Dancer Soul':                               ('Soul',     True,  0x103D, None),
    'Dead hand Soul':                                  ('Soul',     True,  0x103E, None),
    'Shell Blade Soul':                                ('Soul',     True,  0x103F, None),
    'Like-like Soul':                                  ('Soul',     True,  0x1040, None),
    'Spike Enemy Soul':                                ('Soul',     True,  0x1041, None),
    'Anubis Soul':                                     ('Soul',     True,  0x1042, None),
    'Iron Knuckle Soul':                               ('Soul',     True,  0x1043, None),
    'Skull Kid Soul':                                  ('Soul',     True,  0x1044, None),
    'Flying Pot Soul':                                 ('Soul',     True,  0x1045, None),
    'Freezard Soul':                                   ('Soul',     True,  0x1046, None),
    'Stinger Soul':                                    ('Soul',     True,  0x1047, None),
    'Wolfos Soul':                                     ('Soul',     True,  0x1048, None),
    'Guay Soul':                                       ('Soul',     True,  0x1049, None),
    'Queen Gohma Soul':                                ('Soul',     True,  0x104A, None),
    'King Dodongo Soul':                               ('Soul',     True,  0x104B, None),
    'Barinade Soul':                                   ('Soul',     True,  0x104C, None),
    'Phantom Ganon Soul':                              ('Soul',     True,  0x104D, None),
    'Volvagia Soul':                                   ('Soul',     True,  0x104E, None),
    'Morpha Soul':                                     ('Soul',     True,  0x104F, None),
    'Bongo Bongo Soul':                                ('Soul',     True,  0x1050, None),
    'Twinrova Soul':                                   ('Soul',     True,  0x1051, None),
    'Jabu Jabu Tentacle Soul':                         ('Soul',     True,  0x1052, None),
    'Dark Link Soul':                                  ('Soul',     True,  0x1053, None),
