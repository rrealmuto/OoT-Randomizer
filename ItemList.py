...
item_table: dict[str, tuple[str, Optional[bool], Optional[int], Optional[dict[str, Any]]]] = {
    ...
    'Stalfos Soul': ('Item', True, 0x119, None),
    'Octorok Soul': ('Item', True, 0x11A, None),
    'Wallmaster Soul': ('Item', True, 0x11B, None),
    'Dodongo Soul': ('Item', True, 0x11C, None),
    'Keese Soul': ('Item', True, 0x11D, None),
    'Tektite Soul': ('Item', True, 0x11E, None),
    'Peahat Soul': ('Item', True, 0x11F, None),
    'Lizalfos and Dinalfos Soul': ('Item', True, 0x120, None),
    'Gohma Larvae Soul': ('Item', True, 0x121, None),
    'Shabom Soul': ('Item', True, 0x122, None),
    'Baby Dodongo Soul': ('Item', True, 0x123, None),
    'Biri and Bari Soul': ('Item', True, 0x124, None),
    'Tailpasaran Soul': ('Item', True, 0x125, None),
    'Skulltula Soul': ('Item', True, 0x126, None),
    'Torch Slug Soul': ('Item', True, 0x127, None),
    'Moblin Soul': ('Item', True, 0x128, None),
    'Armos Soul': ('Item', True, 0x129, None),
    'Deku Baba Soul': ('Item', True, 0x12A, None),
    'Deku Scrub Soul': ('Item', True, 0x12B, None),
    'Bubble Soul': ('Item', True, 0x12C, None),
    'Beamos Soul': ('Item', True, 0x12D, None),
    'Floormaster Soul': ('Item', True, 0x12E, None),
    'Redead and Gibdo Soul': ('Item', True, 0x12F, None),
    'Skullwalltula Soul': ('Item', True, 0x130, None),
    'Flare Dancer Soul': ('Item', True, 0x131, None),
    'Dead hand Soul': ('Item', True, 0x132, None),
    'Shell blade Soul': ('Item', True, 0x133, None),
    'Like-like Soul': ('Item', True, 0x134, None),
    'Spike Enemy Soul': ('Item', True, 0x135, None),
    'Anubis Soul': ('Item', True, 0x136, None),
    'Iron Knuckle Soul': ('Item', True, 0x137, None),
    'Skull Kid Soul': ('Item', True, 0x138, None),
    'Flying Pot Soul': ('Item', True, 0x139, None),
    'Freezard Soul': ('Item', True, 0x13A, None),
    'Stinger Soul': ('Item', True, 0x13B, None),
    'Wolfos Soul': ('Item', True, 0x13C, None),
    'Guay Soul': ('Item', True, 0x13D, None),
    'Queen Gohma Soul': ('Item', True, 0x13E, None),
    'King Dodongo Soul': ('Item', True, 0x13F, None),
    'Barinade Soul': ('Item', True, 0x140, None),
    'Phantom Ganon Soul': ('Item', True, 0x141, None),
    'Volvagia Soul': ('Item', True, 0x142, None),
    ...
    'Ganondorf Soul': ('Item', True, 0x147, None),
    'Dark Link Soul': ('Item', True, 0x148, None),
