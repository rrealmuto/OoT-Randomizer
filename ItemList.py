...
item_table: dict[str, tuple[str, Optional[bool], Optional[int], Optional[dict[str, Any]]]] = {
    ...
    'Fairy Drop':                                      ('Item',     True,  0x0119, None),
    'Nothing':                                         ('Item',     True,  0x011A, None),

    'Stalfos Soul':                                    ('Soul',     True,  0x011B, None),
    'Octorok Soul':                                    ('Soul',     True,  0x011C, None),
    'Wallmaster Soul':                                 ('Soul',     True,  0x011D, None),
    'Dodongo Soul':                                    ('Soul',     True,  0x011E, None),
    'Keese Soul':                                      ('Soul',     True,  0x011F, None),
    'Tektite Soul':                                    ('Soul',     True,  0x0120, None),
    'Peahat Soul':                                     ('Soul',     True,  0x0121, None),
    'Lizalfos and Dinalfos Soul':                      ('Soul',     True,  0x0122, None),
    'Gohma Larvae Soul':                               ('Soul',     True,  0x0123, None),
    'Shabom Soul':                                     ('Soul',     True,  0x0124, None),
    'Baby Dodongo Soul':                               ('Soul',     True,  0x0125, None),
    'Biri and Bari Soul':                              ('Soul',     True,  0x0126, None),
    'Tailpasaran Soul':                                ('Soul',     True,  0x0127, None),
    'Skulltula Soul':                                  ('Soul',     True,  0x0128, None),
    'Torch Slug Soul':                                 ('Soul',     True,  0x0129, None),
    'Moblin Soul':                                     ('Soul',     True,  0x012A, None),
    'Armos Soul':                                      ('Soul',     True,  0x012B, None),
    'Deku Baba Soul':                                  ('Soul',     True,  0x012C, None),
    'Deku Scrub Soul':                                 ('Soul',     True,  0x012D, None),
    'Bubble Soul':                                     ('Soul',     True,  0x012E, None),
    'Beamos Soul':                                     ('Soul',     True,  0x012F, None),
    'Floormaster Soul':                                ('Soul',     True,  0x0130, None),
    'Redead and Gibdo Soul':                           ('Soul',     True,  0x0131, None),
    'Skullwalltula Soul':                              ('Soul',     True,  0x0132, None),
    'Flare Dancer Soul':                               ('Soul',     True,  0x0133, None),
    'Dead hand Soul':                                  ('Soul',     True,  0x0134, None),
    'Shell Blade Soul':                                ('Soul',     True,  0x0135, None),
    'Like-like Soul':                                  ('Soul',     True,  0x0136, None),
    'Spike Enemy Soul':                                ('Soul',     True,  0x0137, None),
    'Anubis Soul':                                     ('Soul',     True,  0x0138, None),
    'Iron Knuckle Soul':                               ('Soul',     True,  0x0139, None),
    'Skull Kid Soul':                                  ('Soul',     True,  0x013A, None),
    'Flying Pot Soul':                                 ('Soul',     True,  0x013B, None),
    'Freezard Soul':                                   ('Soul',     True,  0x013C, None),
    'Stinger Soul':                                    ('Soul',     True,  0x013D, None),
    'Wolfos Soul':                                     ('Soul',     True,  0x013E, None),
    'Guay Soul':                                       ('Soul',     True,  0x013F, None),
    'Queen Gohma Soul':                                ('Soul',     True,  0x0140, None),
    'King Dodongo Soul':                               ('Soul',     True,  0x0141, None),
    'Barinade Soul':                                   ('Soul',     True,  0x0142, None),
    'Phantom Ganon Soul':                              ('Soul',     True,  0x0143, None),
    'Volvagia Soul':                                   ('Soul',     True,  0x0144, None),
    'Morpha Soul':                                     ('Soul',     True,  0x0145, None),
    'Bongo Bongo Soul':                                ('Soul',     True,  0x0146, None),
    'Twinrova Soul':                                   ('Soul',     True,  0x0147, None),
    'Jabu Jabu Tentacle Soul':                         ('Soul',     True,  0x0148, None),
    'Dark Link Soul':                                  ('Soul',     True,  0x0149, None),
