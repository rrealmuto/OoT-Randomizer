...
item_table = {
    ...
    'Silver Rupee (Shadow Temple Invisible Blades)':            ('Item',     True,  0xD9, {'progressive': 10}),
    'Silver Rupee (Shadow Temple Huge Pit)':                    ('Item',     True,  0xDA, {'progressive': 5}),
    'Silver Rupee (Shadow Temple Invisible Spikes)':            ('Item',     True,  0xDB, {'progressive': 10}),
    'Silver Rupee (Gerudo Training Ground Slopes)':             ('Item',     True,  0xDC, {'progressive': 5}),
    'Silver Rupee (Gerudo Training Ground Lava)':               ('Item',     True,  0xDD, {'progressive': 6}),
    'Silver Rupee (Gerudo Training Ground Water)':              ('Item',     True,  0xDE, {'progressive': 5}),
    'Silver Rupee (Spirit Temple Child Early Torches)':         ('Item',     True,  0xDF, {'progressive': 5}),
    'Silver Rupee (Spirit Temple Adult Boulders)':              ('Item',     True,  0xE0, {'progressive': 5}),
    'Silver Rupee (Spirit Temple Lobby and Lower Adult)':       ('Item',     True,  0xE1, {'progressive': 5}),
    'Silver Rupee (Spirit Temple Sun Block)':                   ('Item',     True,  0xE2, {'progressive': 5}),
    'Silver Rupee (Spirit Temple Adult Climb)':                 ('Item',     True,  0xE3, {'progressive': 5}),
    'Silver Rupee (Ganons Castle Spirit Trial)':                ('Item',     True,  0xE4, {'progressive': 5}),
    'Silver Rupee (Ganons Castle Light Trial)':                 ('Item',     True,  0xE5, {'progressive': 5}),
    'Silver Rupee (Ganons Castle Fire Trial)':                  ('Item',     True,  0xE6, {'progressive': 5}),
    'Silver Rupee (Ganons Castle Shadow Trial)':                ('Item',     True,  0xE7, {'progressive': 5}),
    'Silver Rupee (Ganons Castle Water Trial)':                 ('Item',     True,  0xE8, {'progressive': 5}),
    ...
    'Silver Rupee Pouch (Shadow Temple Invisible Blades)':      ('Item',     True,  0xEF, {'alias': ('Silver Rupee (Shadow Temple Invisible Blades)', 10), 'progressive': 1}),
    'Silver Rupee Pouch (Shadow Temple Huge Pit)':              ('Item',     True,  0xF0, {'alias': ('Silver Rupee (Shadow Temple Huge Pit)', 10), 'progressive': 1}),
    'Silver Rupee Pouch (Shadow Temple Invidible Spikes)':      ('Item',     True,  0xF1, {'alias': ('Silver Rupee (Shadow Temple Invidible Spikes)', 10), 'progressive': 1}),
    'Silver Rupee Pouch (Gerudo Training Ground Slopes)':       ('Item',     True,  0xF2, {'alias': ('Silver Rupee (Gerudo Training Ground Slopes)', 10), 'progressive': 1}),
    'Silver Rupee Pouch (Gerudo Training Ground Lava)':         ('Item',     True,  0xF3, {'alias': ('Silver Rupee (Gerudo Training Ground Lava)', 10), 'progressive': 1}),
    'Silver Rupee Pouch (Gerudo Training Ground Water)':        ('Item',     True,  0xF4, {'alias': ('Silver Rupee (Gerudo Training Ground Water)', 10), 'progressive': 1}),
    'Silver Rupee Pouch (Spirit Temple Child Early Torches)':   ('Item',     True,  0xF5, {'alias': ('Silver Rupee (Spirit Temple Child Early Torches)', 10), 'progressive': 1}),
    'Silver Rupee Pouch (Spirit Temple Adult Boulders)':        ('Item',     True,  0xF6, {'alias': ('Silver Rupee (Spirit Temple Adult Boulders)', 10), 'progressive': 1}),
    'Silver Rupee Pouch (Spirit Temple Lobby and Lower Adult)': ('Item',     True,  0xF7, {'alias': ('Silver Rupee (Spirit Temple Lobby and Lower Adult)', 10), 'progressive': 1}),
    'Silver Rupee Pouch (Spirit Temple Sun Block)':             ('Item',     True,  0xF8, {'alias': ('Silver Rupee (Spirit Temple Sun Block)', 10), 'progressive': 1}),
    'Silver Rupee Pouch (Spirit Temple Adult Climb)':           ('Item',     True,  0xF9, {'alias': ('Silver Rupee (Spirit Temple Adult Climb)', 10), 'progressive': 1}),
    'Silver Rupee Pouch (Ganons Castle Spirit Trial)':          ('Item',     True,  0xFA, {'alias': ('Silver Rupee (Ganons Castle Spirit Trial)', 10), 'progressive': 1}),
    'Silver Rupee Pouch (Ganons Castle Light Trial)':           ('Item',     True,  0xFB, {'alias': ('Silver Rupee (Ganons Castle Light Trial)', 10), 'progressive': 1}),
    'Silver Rupee Pouch (Ganons Castle Fire Trial)':            ('Item',     True,  0xFC, {'alias': ('Silver Rupee (Ganons Castle Fire Trial)', 10), 'progressive': 1}),
    'Silver Rupee Pouch (Ganons Castle Shadow Trial)':          ('Item',     True,  0xFD, {'alias': ('Silver Rupee (Ganons Castle Shadow Trial)', 10), 'progressive': 1}),
    'Silver Rupee Pouch (Ganons Castle Water Trial)':           ('Item',     True,  0xFE, {'alias': ('Silver Rupee (Ganons Castle Water Trial)', 10), 'progressive': 1}),
    'Silver Rupee Pouch (Ganons Castle Forest Trial)':          ('Item',     True,  0xFF, {'alias': ('Silver Rupee (Ganons Castle Forest Trial)', 10), 'progressive': 1}),
