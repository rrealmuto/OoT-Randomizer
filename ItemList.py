...
item_table = {
    ...
    'Silver Rupee (Shadow Temple Huge Pit)' :                   ('Item',     True,  0xD4, {'progressive': float('Inf')}),
    'Silver Rupee (Shadow Temple Spinner Room)' :               ('Item',     True,  0xD5, {'progressive': float('Inf')}),
    'Silver Rupee (Shadow Temple Invisible Spikes)' :           ('Item',     True,  0xD6, {'progressive': float('Inf')}),
    'Silver Rupee (Ice Cavern Spinning Blade)' :                ('Item',     True,  0xD7, {'progressive': float('Inf')}),
    'Silver Rupee (Ice Cavern Block Push)' :                    ('Item',     True,  0xD8, {'progressive': float('Inf')}),
    'Silver Rupee (GTG Lava Room)' :                            ('Item',     True,  0xD9, {'progressive': float('Inf')}),
    'Silver Rupee (GTG Underwater)' :                           ('Item',     True,  0xDA, {'progressive': float('Inf')}),
    'Silver Rupee (GTG Boulder Room)' :                         ('Item',     True,  0xDB, {'progressive': float('Inf')}),
