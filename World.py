...
class World(object):
    ...
    def __init__(self, id, settings, resolveRandomizedSettings=True):
        ...
        for hint_type in ('goal', 'dual', 'dual_always', 'entrance_always', 'dual-woth', 'woth-count', 'goal-legacy', 'goal-count', 'playthrough-location', 'blitz%', 'unlock-woth', 'unlock-playthrough'):
