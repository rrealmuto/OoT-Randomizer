...
item_draw_table_entry_t item_draw_table[] = {
    ...
    [0x1D] = { draw_gi_opa_with_rainbow_flame,      { 0x06000580, 0x0000ffFF, 0x0000ffFF } }, // Small Magic Jar
    [0x1E] = { draw_gi_opa_with_rainbow_flame,      { 0x06000EE0, 0x0000ffFF, 0x0000ffFF } }, // Large Magic Jar
    ...
    [0x33] = { draw_gi_various_opa0,        { 0x06000e08 } }, // Boomerang
