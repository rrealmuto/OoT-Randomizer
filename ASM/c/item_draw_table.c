...
item_draw_table_entry_t item_draw_table[] = {
    ...
    [0x1D] = { draw_gi_opa_with_rainbow_flame,        { {0x06000580}, {0xe0d4ffFF}, {0xd4ffe2FF} } }, // Small Magic Jar
    [0x1E] = { draw_gi_opa_with_rainbow_flame,        { {0x06000EE0}, {0xe0d4ffFF}, {0xd4ffe2FF} } }, // Large Magic Jar
