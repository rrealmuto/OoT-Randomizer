...
item_row_t item_table[] = {
    ...
    [0xD5] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x85, -1, 0x901A, 0x0196, 0x72, no_upgrade, give_silver_rupee, ICE_ID,     0x01), // Silver Rupee (Ice Cavern Spinning Scythe)
    ...
    [0xEB] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9030, 0x0196, 0x72, no_upgrade, give_silver_rupee_pouch, ICE_ID,     0x01), // Silver Rupee Pouch (Ice Cavern Spinning Scythe)
   ...
   [0x106] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x9049, 0x0193, 0x76, no_upgrade, give_triforce_piece, -1, -1), // Triforce of Courage
};
