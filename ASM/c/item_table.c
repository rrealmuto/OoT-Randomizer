...
item_row_t item_table[] = {
    ...
    [0xD4] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x9045, 0x0196, 0x29, no_upgrade, give_triforce_piece, -1, -1), // Easter egg (pink)
    [0xD5] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x9045, 0x0197, 0x29, no_upgrade, give_triforce_piece, -1, -1), // Easter egg (orange)
    [0xD6] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x9045, 0x0198, 0x29, no_upgrade, give_triforce_piece, -1, -1), // Easter egg (green)
    [0xD7] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x9045, 0x0199, 0x29, no_upgrade, give_triforce_piece, -1, -1), // Easter egg (blue)
};
