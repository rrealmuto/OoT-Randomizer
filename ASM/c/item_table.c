...
item_row_t item_table[] = {
    ...
    [0x2101] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x9501, 0x00F4, 0x3F, no_upgrade, give_fish,        6, 1, NULL), // Fish (child, 6 lb)
    [0x2102] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x9502, 0x00F4, 0x3F, no_upgrade, give_fish,        8, 1, NULL), // Fish (child, 8 lb)
    [0x2103] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x9503, 0x00F4, 0x3F, no_upgrade, give_fish,        10, 1, NULL), // Fish (child, 10 lb)
    [0x2104] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x9504, 0x00F4, 0x3F, no_upgrade, give_fish,        10, 0, NULL), // Fish (adult, 10 lb)
    [0x2105] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x9505, 0x00F4, 0x3F, no_upgrade, give_fish,        12, 0, NULL), // Fish (adult, 12 lb)
    [0x2106] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x9506, 0x00F4, 0x3F, no_upgrade, give_fish,        16, 0, NULL), // Fish (adult, 16 lb)
    [0x2107] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x9507, 0x00F4, 0x3F, no_upgrade, give_fish,        30, 0, NULL), // Hylian Loach
};
