...
item_row_t item_table[] = {
    ...
    [0x00D7] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x901B, 0x0198, 0x7F, no_upgrade, unlock_ocarina_note, 0, -1), // Ocarina A
    [0x00D8] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x901C, 0x019A, 0x80, no_upgrade, unlock_ocarina_note, 1, -1), // Ocarina C up
    [0x00D9] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x901D, 0x019A, 0x81, no_upgrade, unlock_ocarina_note, 2, -1), // Ocarina C down
    [0x00DA] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x901E, 0x0199, 0x82, no_upgrade, unlock_ocarina_note, 3, -1), // Ocarina C left
    [0x00DB] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x901F, 0x0199, 0x83, no_upgrade, unlock_ocarina_note, 4, -1), // Ocarina C right
};
