...
item_row_t item_table[] = {
    ...
    [0x0119] = ITEM_ROW(0x53, HEART_CHEST_SMALL, 0x41, -1, 0x9091, 0x0177, 0x95, no_upgrade, full_heal, -1, -1, NULL), // Fairy
    [0x011A] = ITEM_ROW(0x53,       BROWN_CHEST, 0x41, -1, 0x9092, 0x0177, 0x96, no_upgrade, no_effect, -1, -1, NULL), // Nothing :)
};
