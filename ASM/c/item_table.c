...
item_row_t item_table[] = {
    ...
    [0xD4] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x85, -1, 0x9019, 0x0197, 0x72, no_upgrade, give_silver_rupee, DODONGO_ID, 0x00, NULL), // Silver Rupee (Dodongos Cavern Staircase)
    [0xD5] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x85, -1, 0x901A, 0x0197, 0x72, no_upgrade, give_silver_rupee, ICE_ID,     0x01, NULL), // Silver Rupee (Ice Cavern Spinning Scythe)
    [0xD6] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x85, -1, 0x901B, 0x0197, 0x72, no_upgrade, give_silver_rupee, ICE_ID,     0x02, NULL), // Silver Rupee (Ice Cavern Push Block)
    [0xD7] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x85, -1, 0x901C, 0x0197, 0x72, no_upgrade, give_silver_rupee, BOTW_ID,    0x03, NULL), // Silver Rupee (Bottom of the Well Basement)
    [0xD8] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x85, -1, 0x901D, 0x0197, 0x72, no_upgrade, give_silver_rupee, SHADOW_ID,  0x04, NULL), // Silver Rupee (Shadow Temple Scythe Shortcut)
    [0xD9] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x85, -1, 0x901E, 0x0197, 0x72, no_upgrade, give_silver_rupee, SHADOW_ID,  0x05, NULL), // Silver Rupee (Shadow Temple Invisible Blades)
    [0xDA] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x85, -1, 0x901F, 0x0197, 0x72, no_upgrade, give_silver_rupee, SHADOW_ID,  0x06, NULL), // Silver Rupee (Shadow Temple Huge Pit)
    [0xDB] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x85, -1, 0x9020, 0x0197, 0x72, no_upgrade, give_silver_rupee, SHADOW_ID,  0x07, NULL), // Silver Rupee (Shadow Temple Invisible Spikes)
    [0xDC] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x85, -1, 0x9021, 0x0197, 0x72, no_upgrade, give_silver_rupee, GTG_ID,     0x08, NULL), // Silver Rupee (Gerudo Training Ground Slopes)
    [0xDD] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x85, -1, 0x9022, 0x0197, 0x72, no_upgrade, give_silver_rupee, GTG_ID,     0x09, NULL), // Silver Rupee (Gerudo Training Ground Lava)
    [0xDE] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x85, -1, 0x9023, 0x0197, 0x72, no_upgrade, give_silver_rupee, GTG_ID,     0x0A, NULL), // Silver Rupee (Gerudo Training Ground Water)
    [0xDF] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x85, -1, 0x9024, 0x0197, 0x72, no_upgrade, give_silver_rupee, SPIRIT_ID,  0x0B, NULL), // Silver Rupee (Spirit Temple Child Early Torches)
    [0xE0] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x85, -1, 0x9025, 0x0197, 0x72, no_upgrade, give_silver_rupee, SPIRIT_ID,  0x0C, NULL), // Silver Rupee (Spirit Temple Adult Boulders)
    [0xE1] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x85, -1, 0x9026, 0x0197, 0x72, no_upgrade, give_silver_rupee, SPIRIT_ID,  0x0D, NULL), // Silver Rupee (Spirit Temple Lobby and Lower Adult)
    [0xE2] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x85, -1, 0x9027, 0x0197, 0x72, no_upgrade, give_silver_rupee, SPIRIT_ID,  0x0E, NULL), // Silver Rupee (Spirit Temple Sun Block)
    [0xE3] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x85, -1, 0x9028, 0x0197, 0x72, no_upgrade, give_silver_rupee, SPIRIT_ID,  0x0F, NULL), // Silver Rupee (Spirit Temple Adult Climb)
    [0xE4] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x85, -1, 0x9029, 0x0197, 0x72, no_upgrade, give_silver_rupee, CASTLE_ID,  0x10, NULL), // Silver Rupee (Ganons Castle Spirit Trial)
    [0xE5] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x85, -1, 0x902A, 0x0197, 0x72, no_upgrade, give_silver_rupee, CASTLE_ID,  0x11, NULL), // Silver Rupee (Ganons Castle Light Trial)
    [0xE6] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x85, -1, 0x902B, 0x0197, 0x72, no_upgrade, give_silver_rupee, CASTLE_ID,  0x12, NULL), // Silver Rupee (Ganons Castle Fire Trial)
    [0xE7] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x85, -1, 0x902C, 0x0197, 0x72, no_upgrade, give_silver_rupee, CASTLE_ID,  0x13, NULL), // Silver Rupee (Ganons Castle Shadow Trial)
    [0xE8] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x85, -1, 0x902D, 0x0197, 0x72, no_upgrade, give_silver_rupee, CASTLE_ID,  0x14, NULL), // Silver Rupee (Ganons Castle Water Trial)
    [0xE9] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x85, -1, 0x902E, 0x0197, 0x72, no_upgrade, give_silver_rupee, CASTLE_ID,  0x15, NULL), // Silver Rupee (Ganons Castle Forest Trial)

    [0xEA] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x902F, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, DODONGO_ID, 0x00, NULL), // Silver Rupee Pouch (Dodongos Cavern Staircase)
    [0xEB] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9030, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, ICE_ID,     0x01, NULL), // Silver Rupee Pouch (Ice Cavern Spinning Scythe)
    [0xEC] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9031, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, ICE_ID,     0x02, NULL), // Silver Rupee Pouch (Ice Cavern Push Block)
    [0xED] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9032, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, BOTW_ID,    0x03, NULL), // Silver Rupee Pouch (Bottom of the Well Basement)
    [0xEE] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9033, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, SHADOW_ID,  0x04, NULL), // Silver Rupee Pouch (Shadow Temple Scythe Shortcut)
    [0xEF] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9034, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, SHADOW_ID,  0x05, NULL), // Silver Rupee Pouch (Shadow Temple Invisible Blades)
    [0xF0] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9035, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, SHADOW_ID,  0x06, NULL), // Silver Rupee Pouch (Shadow Temple Huge Pit)
    [0xF1] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9036, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, SHADOW_ID,  0x07, NULL), // Silver Rupee Pouch (Shadow Temple Invisible Spikes)
    [0xF2] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9037, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, GTG_ID,     0x08, NULL), // Silver Rupee Pouch (Gerudo Training Ground Slopes)
    [0xF3] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9038, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, GTG_ID,     0x09, NULL), // Silver Rupee Pouch (Gerudo Training Ground Lava)
    [0xF4] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9039, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, GTG_ID,     0x0A, NULL), // Silver Rupee Pouch (Gerudo Training Ground Water)
    [0xF5] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x903A, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, SPIRIT_ID,  0x0B, NULL), // Silver Rupee Pouch (Spirit Temple Child Early Torches)
    [0xF6] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x903B, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, SPIRIT_ID,  0x0C, NULL), // Silver Rupee Pouch (Spirit Temple Adult Boulders)
    [0xF7] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x903C, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, SPIRIT_ID,  0x0D, NULL), // Silver Rupee Pouch (Spirit Temple Lobby and Lower Adult)
    [0xF8] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x903D, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, SPIRIT_ID,  0x0E, NULL), // Silver Rupee Pouch (Spirit Temple Sun Block)
    [0xF9] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x903E, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, SPIRIT_ID,  0x0F, NULL), // Silver Rupee Pouch (Spirit Temple Adult Climb)
    [0xFA] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x903F, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, CASTLE_ID,  0x10, NULL), // Silver Rupee Pouch (Ganons Castle Spirit Trial)
    [0xFB] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9040, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, CASTLE_ID,  0x11, NULL), // Silver Rupee Pouch (Ganons Castle Light Trial)
    [0xFC] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9041, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, CASTLE_ID,  0x12, NULL), // Silver Rupee Pouch (Ganons Castle Fire Trial)
    [0xFD] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9042, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, CASTLE_ID,  0x13, NULL), // Silver Rupee Pouch (Ganons Castle Shadow Trial)
    [0xFE] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9043, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, CASTLE_ID,  0x14, NULL), // Silver Rupee Pouch (Ganons Castle Water Trial)
    [0xFF] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9044, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, CASTLE_ID,  0x15, NULL), // Silver Rupee Pouch (Ganons Castle Forest Trial)
};
