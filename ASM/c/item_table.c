...
item_row_t item_table[] = {
    ...
    [0xAF] = ITEM_ROW(0x53,      SILVER_CHEST, 0x41, -1, 0x0093, 0x00AA, 0x7F, no_upgrade, give_small_key, FOREST_ID, -1, NULL), // Forest Temple Small Key
    [0xB0] = ITEM_ROW(0x53,      SILVER_CHEST, 0x41, -1, 0x0094, 0x00AA, 0x80, no_upgrade, give_small_key, FIRE_ID,   -1, NULL), // Fire Temple Small Key
    [0xB1] = ITEM_ROW(0x53,      SILVER_CHEST, 0x41, -1, 0x0095, 0x00AA, 0x81, no_upgrade, give_small_key, WATER_ID,  -1, NULL), // Water Temple Small Key
    [0xB2] = ITEM_ROW(0x53,      SILVER_CHEST, 0x41, -1, 0x00A6, 0x00AA, 0x82, no_upgrade, give_small_key, SPIRIT_ID, -1, NULL), // Spirit Temple Small Key
    [0xB3] = ITEM_ROW(0x53,      SILVER_CHEST, 0x41, -1, 0x00A9, 0x00AA, 0x83, no_upgrade, give_small_key, SHADOW_ID, -1, NULL), // Shadow Temple Small Key
    ...
    [0xEA] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x902F, 0x00D1, 0x7E, no_upgrade, give_silver_rupee_pouch, DODONGO_ID, 0x00, NULL), // Silver Rupee Pouch (Dodongos Cavern Staircase)
    [0xEB] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9030, 0x00D1, 0x7E, no_upgrade, give_silver_rupee_pouch, ICE_ID,     0x01, NULL), // Silver Rupee Pouch (Ice Cavern Spinning Scythe)
    [0xEC] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9031, 0x00D1, 0x7E, no_upgrade, give_silver_rupee_pouch, ICE_ID,     0x02, NULL), // Silver Rupee Pouch (Ice Cavern Push Block)
    [0xED] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9032, 0x00D1, 0x7E, no_upgrade, give_silver_rupee_pouch, BOTW_ID,    0x03, NULL), // Silver Rupee Pouch (Bottom of the Well Basement)
    [0xEE] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9033, 0x00D1, 0x7E, no_upgrade, give_silver_rupee_pouch, SHADOW_ID,  0x04, NULL), // Silver Rupee Pouch (Shadow Temple Scythe Shortcut)
    [0xEF] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9034, 0x00D1, 0x7E, no_upgrade, give_silver_rupee_pouch, SHADOW_ID,  0x05, NULL), // Silver Rupee Pouch (Shadow Temple Invisible Blades)
    [0xF0] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9035, 0x00D1, 0x7E, no_upgrade, give_silver_rupee_pouch, SHADOW_ID,  0x06, NULL), // Silver Rupee Pouch (Shadow Temple Huge Pit)
    [0xF1] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9036, 0x00D1, 0x7E, no_upgrade, give_silver_rupee_pouch, SHADOW_ID,  0x07, NULL), // Silver Rupee Pouch (Shadow Temple Invisible Spikes)
    [0xF2] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9037, 0x00D1, 0x7E, no_upgrade, give_silver_rupee_pouch, GTG_ID,     0x08, NULL), // Silver Rupee Pouch (Gerudo Training Ground Slopes)
    [0xF3] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9038, 0x00D1, 0x7E, no_upgrade, give_silver_rupee_pouch, GTG_ID,     0x09, NULL), // Silver Rupee Pouch (Gerudo Training Ground Lava)
    [0xF4] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9039, 0x00D1, 0x7E, no_upgrade, give_silver_rupee_pouch, GTG_ID,     0x0A, NULL), // Silver Rupee Pouch (Gerudo Training Ground Water)
    [0xF5] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x903A, 0x00D1, 0x7E, no_upgrade, give_silver_rupee_pouch, SPIRIT_ID,  0x0B, NULL), // Silver Rupee Pouch (Spirit Temple Child Early Torches)
    [0xF6] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x903B, 0x00D1, 0x7E, no_upgrade, give_silver_rupee_pouch, SPIRIT_ID,  0x0C, NULL), // Silver Rupee Pouch (Spirit Temple Adult Boulders)
    [0xF7] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x903C, 0x00D1, 0x7E, no_upgrade, give_silver_rupee_pouch, SPIRIT_ID,  0x0D, NULL), // Silver Rupee Pouch (Spirit Temple Lobby and Lower Adult)
    [0xF8] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x903D, 0x00D1, 0x7E, no_upgrade, give_silver_rupee_pouch, SPIRIT_ID,  0x0E, NULL), // Silver Rupee Pouch (Spirit Temple Sun Block)
    [0xF9] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x903E, 0x00D1, 0x7E, no_upgrade, give_silver_rupee_pouch, SPIRIT_ID,  0x0F, NULL), // Silver Rupee Pouch (Spirit Temple Adult Climb)
    [0xFA] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x903F, 0x00D1, 0x7E, no_upgrade, give_silver_rupee_pouch, CASTLE_ID,  0x10, NULL), // Silver Rupee Pouch (Ganons Castle Spirit Trial)
    [0xFB] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9040, 0x00D1, 0x7E, no_upgrade, give_silver_rupee_pouch, CASTLE_ID,  0x11, NULL), // Silver Rupee Pouch (Ganons Castle Light Trial)
    [0xFC] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9041, 0x00D1, 0x7E, no_upgrade, give_silver_rupee_pouch, CASTLE_ID,  0x12, NULL), // Silver Rupee Pouch (Ganons Castle Fire Trial)
    [0xFD] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9042, 0x00D1, 0x7E, no_upgrade, give_silver_rupee_pouch, CASTLE_ID,  0x13, NULL), // Silver Rupee Pouch (Ganons Castle Shadow Trial)
    [0xFE] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9043, 0x00D1, 0x7E, no_upgrade, give_silver_rupee_pouch, CASTLE_ID,  0x14, NULL), // Silver Rupee Pouch (Ganons Castle Water Trial)
