...
item_row_t item_table[] = {
    ...
    [0x0095] = ITEM_ROW(0x53,        GOLD_CHEST, 0x41, -1, 0x0006, 0x00B9, 0x8F, no_upgrade, give_dungeon_item, 0x01, FOREST_ID,    NULL), // Forest Temple Boss Key
    [0x0096] = ITEM_ROW(0x53,        GOLD_CHEST, 0x41, -1, 0x001C, 0x00B9, 0x90, no_upgrade, give_dungeon_item, 0x01, FIRE_ID,      NULL), // Fire Temple Boss Key
    [0x0097] = ITEM_ROW(0x53,        GOLD_CHEST, 0x41, -1, 0x001D, 0x00B9, 0x91, no_upgrade, give_dungeon_item, 0x01, WATER_ID,     NULL), // Water Temple Boss Key
    [0x0098] = ITEM_ROW(0x53,        GOLD_CHEST, 0x41, -1, 0x001E, 0x00B9, 0x92, no_upgrade, give_dungeon_item, 0x01, SPIRIT_ID,    NULL), // Spirit Temple Boss Key
    [0x0099] = ITEM_ROW(0x53,        GOLD_CHEST, 0x41, -1, 0x002A, 0x00B9, 0x93, no_upgrade, give_dungeon_item, 0x01, SHADOW_ID,    NULL), // Shadow Temple Boss Key
    [0x009A] = ITEM_ROW(0x53,        GOLD_CHEST, 0x41, -1, 0x0061, 0x00B9, 0x94, no_upgrade, give_dungeon_item, 0x01, TOWER_ID,     NULL), // Ganon's Castle Boss Key
    ...
    [0x00AF] = ITEM_ROW(0x53,      SILVER_CHEST, 0x41, -1, 0x0093, 0x00AA, 0x7F, no_upgrade, give_small_key, FOREST_ID, -1, resolve_text_small_keys), // Forest Temple Small Key
    [0x00B0] = ITEM_ROW(0x53,      SILVER_CHEST, 0x41, -1, 0x0094, 0x00AA, 0x80, no_upgrade, give_small_key, FIRE_ID,   -1, resolve_text_small_keys), // Fire Temple Small Key
    [0x00B1] = ITEM_ROW(0x53,      SILVER_CHEST, 0x41, -1, 0x0095, 0x00AA, 0x81, no_upgrade, give_small_key, WATER_ID,  -1, resolve_text_small_keys), // Water Temple Small Key
    [0x00B2] = ITEM_ROW(0x53,      SILVER_CHEST, 0x41, -1, 0x00A6, 0x00AA, 0x82, no_upgrade, give_small_key, SPIRIT_ID, -1, resolve_text_small_keys), // Spirit Temple Small Key
    [0x00B3] = ITEM_ROW(0x53,      SILVER_CHEST, 0x41, -1, 0x00A9, 0x00AA, 0x83, no_upgrade, give_small_key, SHADOW_ID, -1, resolve_text_small_keys), // Shadow Temple Small Key
    [0x00B4] = ITEM_ROW(0x53,      SILVER_CHEST, 0x41, -1, 0x009B, 0x00AA, 0x84, no_upgrade, give_small_key, BOTW_ID,   -1, resolve_text_small_keys), // Bottom of the Well Small Key
    [0x00B5] = ITEM_ROW(0x53,      SILVER_CHEST, 0x41, -1, 0x009F, 0x00AA, 0x85, no_upgrade, give_small_key, GTG_ID,    -1, resolve_text_small_keys), // Gerudo Training Small Key
    ...
    [0x00B7] = ITEM_ROW(0x53,      SILVER_CHEST, 0x41, -1, 0x00A1, 0x00AA, 0x86, no_upgrade, give_small_key, CASTLE_ID, -1, resolve_text_small_keys), // Ganon's Castle Small Key
    ...
    [0x00CB] = ITEM_ROW(0x53,      SILVER_CHEST, 0x41, -1, 0x9010, 0x0195, 0x87, no_upgrade, give_small_key_ring, FOREST_ID, -1, NULL), // Forest Temple Small Key Ring
    [0x00CC] = ITEM_ROW(0x53,      SILVER_CHEST, 0x41, -1, 0x9011, 0x0195, 0x88, no_upgrade, give_small_key_ring, FIRE_ID,   -1, NULL), // Fire Temple Small Key Ring
    [0x00CD] = ITEM_ROW(0x53,      SILVER_CHEST, 0x41, -1, 0x9012, 0x0195, 0x89, no_upgrade, give_small_key_ring, WATER_ID,  -1, NULL), // Water Temple Small Key Ring
    [0x00CE] = ITEM_ROW(0x53,      SILVER_CHEST, 0x41, -1, 0x9013, 0x0195, 0x8A, no_upgrade, give_small_key_ring, SPIRIT_ID, -1, NULL), // Spirit Temple Small Key Ring
    [0x00CF] = ITEM_ROW(0x53,      SILVER_CHEST, 0x41, -1, 0x9014, 0x0195, 0x8B, no_upgrade, give_small_key_ring, SHADOW_ID, -1, NULL), // Shadow Temple Small Key Ring
    [0x00D0] = ITEM_ROW(0x53,      SILVER_CHEST, 0x41, -1, 0x9015, 0x0195, 0x8C, no_upgrade, give_small_key_ring, BOTW_ID,   -1, NULL), // Bottom of the Well Small Key Ring
    [0x00D1] = ITEM_ROW(0x53,      SILVER_CHEST, 0x41, -1, 0x9016, 0x0195, 0x8D, no_upgrade, give_small_key_ring, GTG_ID,    -1, NULL), // Gerudo Training Small Key Ring
    ...
    [0x00D3] = ITEM_ROW(0x53,      SILVER_CHEST, 0x41, -1, 0x9018, 0x0195, 0x8E, no_upgrade, give_small_key_ring, CASTLE_ID, -1, NULL), // Ganon's Castle Small Key Ring
    ...
    [0x00ED] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x41, -1, 0x901B, 0x00D1, 0x95, no_upgrade, give_silver_rupee_pouch, DODONGO_ID, 0x00, resolve_text_silver_rupee_pouches), // Silver Rupee Pouch (Dodongos Cavern Staircase)
    [0x00EE] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x41, -1, 0x901C, 0x00D1, 0x95, no_upgrade, give_silver_rupee_pouch, ICE_ID,     0x01, resolve_text_silver_rupee_pouches), // Silver Rupee Pouch (Ice Cavern Spinning Scythe)
    [0x00EF] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x41, -1, 0x901D, 0x00D1, 0x95, no_upgrade, give_silver_rupee_pouch, ICE_ID,     0x02, resolve_text_silver_rupee_pouches), // Silver Rupee Pouch (Ice Cavern Push Block)
    [0x00F0] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x41, -1, 0x901E, 0x00D1, 0x95, no_upgrade, give_silver_rupee_pouch, BOTW_ID,    0x03, resolve_text_silver_rupee_pouches), // Silver Rupee Pouch (Bottom of the Well Basement)
    [0x00F1] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x41, -1, 0x901F, 0x00D1, 0x95, no_upgrade, give_silver_rupee_pouch, SHADOW_ID,  0x04, resolve_text_silver_rupee_pouches), // Silver Rupee Pouch (Shadow Temple Scythe Shortcut)
    [0x00F2] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x41, -1, 0x9020, 0x00D1, 0x95, no_upgrade, give_silver_rupee_pouch, SHADOW_ID,  0x05, resolve_text_silver_rupee_pouches), // Silver Rupee Pouch (Shadow Temple Invisible Blades)
    [0x00F3] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x41, -1, 0x9021, 0x00D1, 0x95, no_upgrade, give_silver_rupee_pouch, SHADOW_ID,  0x06, resolve_text_silver_rupee_pouches), // Silver Rupee Pouch (Shadow Temple Huge Pit)
    [0x00F4] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x41, -1, 0x9022, 0x00D1, 0x95, no_upgrade, give_silver_rupee_pouch, SHADOW_ID,  0x07, resolve_text_silver_rupee_pouches), // Silver Rupee Pouch (Shadow Temple Invisible Spikes)
    [0x00F5] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x41, -1, 0x9023, 0x00D1, 0x95, no_upgrade, give_silver_rupee_pouch, GTG_ID,     0x08, resolve_text_silver_rupee_pouches), // Silver Rupee Pouch (Gerudo Training Ground Slopes)
    [0x00F6] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x41, -1, 0x9024, 0x00D1, 0x95, no_upgrade, give_silver_rupee_pouch, GTG_ID,     0x09, resolve_text_silver_rupee_pouches), // Silver Rupee Pouch (Gerudo Training Ground Lava)
    [0x00F7] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x41, -1, 0x9025, 0x00D1, 0x95, no_upgrade, give_silver_rupee_pouch, GTG_ID,     0x0A, resolve_text_silver_rupee_pouches), // Silver Rupee Pouch (Gerudo Training Ground Water)
    [0x00F8] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x41, -1, 0x9026, 0x00D1, 0x95, no_upgrade, give_silver_rupee_pouch, SPIRIT_ID,  0x0B, resolve_text_silver_rupee_pouches), // Silver Rupee Pouch (Spirit Temple Child Early Torches)
    [0x00F9] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x41, -1, 0x9027, 0x00D1, 0x95, no_upgrade, give_silver_rupee_pouch, SPIRIT_ID,  0x0C, resolve_text_silver_rupee_pouches), // Silver Rupee Pouch (Spirit Temple Adult Boulders)
    [0x00FA] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x41, -1, 0x9028, 0x00D1, 0x95, no_upgrade, give_silver_rupee_pouch, SPIRIT_ID,  0x0D, resolve_text_silver_rupee_pouches), // Silver Rupee Pouch (Spirit Temple Lobby and Lower Adult)
    [0x00FB] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x41, -1, 0x9029, 0x00D1, 0x95, no_upgrade, give_silver_rupee_pouch, SPIRIT_ID,  0x0E, resolve_text_silver_rupee_pouches), // Silver Rupee Pouch (Spirit Temple Sun Block)
    [0x00FC] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x41, -1, 0x902A, 0x00D1, 0x95, no_upgrade, give_silver_rupee_pouch, SPIRIT_ID,  0x0F, resolve_text_silver_rupee_pouches), // Silver Rupee Pouch (Spirit Temple Adult Climb)
    [0x00FD] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x41, -1, 0x902B, 0x00D1, 0x95, no_upgrade, give_silver_rupee_pouch, CASTLE_ID,  0x10, resolve_text_silver_rupee_pouches), // Silver Rupee Pouch (Ganons Castle Spirit Trial)
    [0x00FE] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x41, -1, 0x902C, 0x00D1, 0x95, no_upgrade, give_silver_rupee_pouch, CASTLE_ID,  0x11, resolve_text_silver_rupee_pouches), // Silver Rupee Pouch (Ganons Castle Light Trial)
    [0x00FF] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x41, -1, 0x902D, 0x00D1, 0x95, no_upgrade, give_silver_rupee_pouch, CASTLE_ID,  0x12, resolve_text_silver_rupee_pouches), // Silver Rupee Pouch (Ganons Castle Fire Trial)
