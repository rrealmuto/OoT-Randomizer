...
item_row_t item_table[GI_RANDO_MAX] = {
    ...
    [GI_BOSS_KEY]                                               = ITEM_ROW(0x53,        BOSSKEY_CHEST, 0x74, -1, 0x00C7, 0x00B9, 0x0A, no_upgrade, no_effect, -1, -1, NULL), // Boss Key
    ...
    [GI_BOSS_KEY_FOREST_TEMPLE]                                 = ITEM_ROW(0x53,        BOSSKEY_CHEST, 0x41, -1, 0x0006, 0x00B9, 0x0A, upgrade_key_model, give_dungeon_item, 0x01, FOREST_ID, NULL), // Forest Temple Boss Key
    [GI_BOSS_KEY_FIRE_TEMPLE]                                   = ITEM_ROW(0x53,        BOSSKEY_CHEST, 0x41, -1, 0x001C, 0x00B9, 0x0A, upgrade_key_model, give_dungeon_item, 0x01, FIRE_ID,   NULL), // Fire Temple Boss Key
    [GI_BOSS_KEY_WATER_TEMPLE]                                  = ITEM_ROW(0x53,        BOSSKEY_CHEST, 0x41, -1, 0x001D, 0x00B9, 0x0A, upgrade_key_model, give_dungeon_item, 0x01, WATER_ID,  NULL), // Water Temple Boss Key
    [GI_BOSS_KEY_SPIRIT_TEMPLE]                                 = ITEM_ROW(0x53,        BOSSKEY_CHEST, 0x41, -1, 0x001E, 0x00B9, 0x0A, upgrade_key_model, give_dungeon_item, 0x01, SPIRIT_ID, NULL), // Spirit Temple Boss Key
    [GI_BOSS_KEY_SHADOW_TEMPLE]                                 = ITEM_ROW(0x53,        BOSSKEY_CHEST, 0x41, -1, 0x002A, 0x00B9, 0x0A, upgrade_key_model, give_dungeon_item, 0x01, SHADOW_ID, NULL), // Shadow Temple Boss Key
    [GI_BOSS_KEY_GANONS_CASTLE]                                 = ITEM_ROW(0x53,        BOSSKEY_CHEST, 0x41, -1, 0x0061, 0x00B9, 0x0A, upgrade_key_model, give_dungeon_item, 0x01, TOWER_ID,  NULL), // Ganon's Castle Boss Key
    ...
    // Custom Key Models
    [GI_BOSS_KEY_MODEL_FOREST_TEMPLE]                           = ITEM_ROW(0x53,        BOSSKEY_CHEST, 0x41, -1, 0x0006, 0x01A3, 0x8A, no_upgrade, give_dungeon_item, 0x01, FOREST_ID, NULL), // Forest Temple Boss Key
    [GI_BOSS_KEY_MODEL_FIRE_TEMPLE]                             = ITEM_ROW(0x53,        BOSSKEY_CHEST, 0x41, -1, 0x001C, 0x01A4, 0x8B, no_upgrade, give_dungeon_item, 0x01, FIRE_ID,   NULL), // Fire Temple Boss Key
    [GI_BOSS_KEY_MODEL_WATER_TEMPLE]                            = ITEM_ROW(0x53,        BOSSKEY_CHEST, 0x41, -1, 0x001D, 0x01A5, 0x8C, no_upgrade, give_dungeon_item, 0x01, WATER_ID,  NULL), // Water Temple Boss Key
    [GI_BOSS_KEY_MODEL_SPIRIT_TEMPLE]                           = ITEM_ROW(0x53,        BOSSKEY_CHEST, 0x41, -1, 0x001E, 0x01A6, 0x8D, no_upgrade, give_dungeon_item, 0x01, SPIRIT_ID, NULL), // Spirit Temple Boss Key
    [GI_BOSS_KEY_MODEL_SHADOW_TEMPLE]                           = ITEM_ROW(0x53,        BOSSKEY_CHEST, 0x41, -1, 0x002A, 0x01A7, 0x8E, no_upgrade, give_dungeon_item, 0x01, SHADOW_ID, NULL), // Shadow Temple Boss Key
    [GI_BOSS_KEY_MODEL_GANONS_CASTLE]                           = ITEM_ROW(0x53,        BOSSKEY_CHEST, 0x41, -1, 0x0061, 0x00B9, 0x8F, no_upgrade, give_dungeon_item, 0x01, TOWER_ID,  NULL), // Ganon's Castle Boss Key
    ...
    [GI_SOUL_STALFOS]                                           = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9300, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 0, -1, NULL),
    [GI_SOUL_OCTOROK]                                           = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9301, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 1, -1, NULL),
    [GI_SOUL_WALLMASTER]                                        = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9302, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 2, -1, NULL),
    [GI_SOUL_DODONGO]                                           = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9303, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 3, -1, NULL),
    [GI_SOUL_KEESE]                                             = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9304, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 4, -1, NULL),
    [GI_SOUL_TEKTITE]                                           = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9305, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 5, -1, NULL),
    [GI_SOUL_PEAHAT]                                            = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9306, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 6, -1, NULL),
    [GI_SOUL_LIZALFOS_AND_DINOLFOS]                             = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9307, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 7, -1, NULL),
    [GI_SOUL_GOHMA_LARVAE]                                      = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9308, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 8, -1, NULL),
    [GI_SOUL_SHABOM]                                            = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9309, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 9, -1, NULL),
    [GI_SOUL_BABY_DODONGO]                                      = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x930A, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 10, -1, NULL),
    [GI_SOUL_BIRI_AND_BARI]                                     = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x930B, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 11, -1, NULL),
    [GI_SOUL_TAILPASARAN]                                       = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x930C, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 12, -1, NULL),
    [GI_SOUL_SKULLTULA]                                         = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x930D, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 13, -1, NULL),
    [GI_SOUL_TORCH_SLUG]                                        = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x930E, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 14, -1, NULL),
    [GI_SOUL_MOBLIN]                                            = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x930F, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 15, -1, NULL),
    [GI_SOUL_ARMOS]                                             = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9310, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 16, -1, NULL),
    [GI_SOUL_DEKU_BABA]                                         = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9311, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 17, -1, NULL),
    [GI_SOUL_DEKU_SCRUB]                                        = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9312, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 18, -1, NULL),
    [GI_SOUL_BUBBLE]                                            = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9313, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 19, -1, NULL),
    [GI_SOUL_BEAMOS]                                            = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9314, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 20, -1, NULL),
    [GI_SOUL_FLOORMASTER]                                       = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9315, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 21, -1, NULL),
    [GI_SOUL_REDEAD_AND_GIBDO]                                  = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9316, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 22, -1, NULL),
    [GI_SOUL_SKULLWALLTULA]                                     = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9317, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 23, -1, NULL),
    [GI_SOUL_FLARE_DANCER]                                      = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9318, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 24, -1, NULL),
    [GI_SOUL_DEAD_HAND]                                         = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9319, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 25, -1, NULL),
    [GI_SOUL_SHELL_BLADE]                                       = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x931A, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 26, -1, NULL),
    [GI_SOUL_LIKE_LIKE]                                         = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x931B, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 27, -1, NULL),
    [GI_SOUL_SPIKE_ENEMY]                                       = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x931C, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 28, -1, NULL),
    [GI_SOUL_ANUBIS]                                            = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x931D, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 29, -1, NULL),
    [GI_SOUL_IRON_KNUCKLE]                                      = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x931E, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 30, -1, NULL),
    [GI_SOUL_SKULL_KID]                                         = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x931F, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 31, -1, NULL),
    [GI_SOUL_FLYING_POT]                                        = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9320, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 32, -1, NULL),
    [GI_SOUL_FREEZARD]                                          = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9321, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 33, -1, NULL),
    [GI_SOUL_STINGER]                                           = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9322, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 34, -1, NULL),
    [GI_SOUL_WOLFOS]                                            = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9323, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 35, -1, NULL),
    [GI_SOUL_GUAY]                                              = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9324, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 36, -1, NULL),
    [GI_SOUL_QUEEN_GOHMA]                                       = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9325, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 37, -1, NULL),
    [GI_SOUL_KING_DODONGO]                                      = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9326, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 38, -1, NULL),
    [GI_SOUL_BARINADE]                                          = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9327, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 39, -1, NULL),
    [GI_SOUL_PHANTOM_GANON]                                     = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9328, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 40, -1, NULL),
    [GI_SOUL_VOLVAGIA]                                          = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9329, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 41, -1, NULL),
    [GI_SOUL_MORPHA]                                            = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x932A, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 42, -1, NULL),
    [GI_SOUL_BONGO_BONGO]                                       = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x932B, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 43, -1, NULL),
    [GI_SOUL_TWINROVA]                                          = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x932C, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 44, -1, NULL),
    [GI_SOUL_JABU_JABU_TENTACLE]                                = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x932D, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 45, -1, NULL),
    [GI_SOUL_DARK_LINK]                                         = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x932E, 0x01B5, 0x63, no_upgrade, give_enemy_soul, 46, -1, NULL),
    [GI_SOUL_REGIONAL_DEKU_TREE]                                = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x932F, 0x01B5, 0x63, no_upgrade, give_regional_enemy_soul, 0, -1, NULL),
    [GI_SOUL_REGIONAL_DODONGOS_CAVERN]                          = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9330, 0x01B5, 0x63, no_upgrade, give_regional_enemy_soul, 1, -1, NULL),
    [GI_SOUL_REGIONAL_JABU]                                     = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9331, 0x01B5, 0x63, no_upgrade, give_regional_enemy_soul, 2, -1, NULL),
    [GI_SOUL_REGIONAL_FOREST_TEMPLE]                            = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9332, 0x01B5, 0x63, no_upgrade, give_regional_enemy_soul, 3, -1, NULL),
    [GI_SOUL_REGIONAL_FIRE_TEMPLE]                              = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9333, 0x01B5, 0x63, no_upgrade, give_regional_enemy_soul, 4, -1, NULL),
    [GI_SOUL_REGIONAL_WATER_TEMPLE]                             = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9334, 0x01B5, 0x63, no_upgrade, give_regional_enemy_soul, 5, -1, NULL),
    [GI_SOUL_REGIONAL_SHADOW_TEMPLE]                            = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9335, 0x01B5, 0x63, no_upgrade, give_regional_enemy_soul, 6, -1, NULL),
    [GI_SOUL_REGIONAL_SPIRIT_TEMPLE]                            = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9336, 0x01B5, 0x63, no_upgrade, give_regional_enemy_soul, 7, -1, NULL),
    [GI_SOUL_REGIONAL_BOTW]                                     = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9337, 0x01B5, 0x63, no_upgrade, give_regional_enemy_soul, 8, -1, NULL),
    [GI_SOUL_REGIONAL_ICE_CAVERN]                               = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9338, 0x01B5, 0x63, no_upgrade, give_regional_enemy_soul, 9, -1, NULL),
    [GI_SOUL_REGIONAL_GTG]                                      = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9339, 0x01B5, 0x63, no_upgrade, give_regional_enemy_soul, 10, -1, NULL),
    [GI_SOUL_REGIONAL_GANONS_CASTLE]                            = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x933A, 0x01B5, 0x63, no_upgrade, give_regional_enemy_soul, 11, -1, NULL),
    [GI_SOUL_REGIONAL_FOREST_AREA]                              = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x933B, 0x01B5, 0x63, no_upgrade, give_regional_enemy_soul, 12, -1, NULL),
    [GI_SOUL_REGIONAL_HYRULE_FIELD]                             = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x933C, 0x01B5, 0x63, no_upgrade, give_regional_enemy_soul, 13, -1, NULL),
    [GI_SOUL_REGIONAL_LAKE_HYLIA]                               = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x933D, 0x01B5, 0x63, no_upgrade, give_regional_enemy_soul, 14, -1, NULL),
    [GI_SOUL_REGIONAL_GERUDO_AREA]                              = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x933E, 0x01B5, 0x63, no_upgrade, give_regional_enemy_soul, 15, -1, NULL),
    [GI_SOUL_REGIONAL_MARKET_AREA]                              = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x933F, 0x01B5, 0x63, no_upgrade, give_regional_enemy_soul, 16, -1, NULL),
    [GI_SOUL_REGIONAL_KAKARIKO_AREA]                            = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9340, 0x01B5, 0x63, no_upgrade, give_regional_enemy_soul, 17, -1, NULL),
    [GI_SOUL_REGIONAL_GORON_AREA]                               = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9341, 0x01B5, 0x63, no_upgrade, give_regional_enemy_soul, 18, -1, NULL),
    [GI_SOUL_REGIONAL_ZORA_AREA]                                = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9342, 0x01B5, 0x63, no_upgrade, give_regional_enemy_soul, 19, -1, NULL),
    [GI_SOUL_REGIONAL_LLR]                                      = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9343, 0x01B5, 0x63, no_upgrade, give_regional_enemy_soul, 20, -1, NULL),
    [GI_SOUL_REGIONAL_GROTTOS]                                  = ITEM_ROW(0x53,        BOSSKEY_CHEST,  0x41, -1, 0x9344, 0x01B5, 0x63, no_upgrade, give_regional_enemy_soul, 21, -1, NULL),
