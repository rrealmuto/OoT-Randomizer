...
item_row_t item_table[] = {
    ...
    // New items in Dev-Rob which are not in main Dev
    // Some IDs are skipped to avoid ambiguity with dev-fenhl, to simplify auto-tracker support

    [0x1009] = ITEM_ROW(0x53, HEART_CHEST_SMALL, 0x41, -1, 0x90B4, 0x0177, 0x95, no_upgrade, full_heal, -1, -1, NULL), // Fairy
    [0x100A] = ITEM_ROW(0x53,       BROWN_CHEST, 0x41, -1, 0x90B5, 0x0177, 0x96, no_upgrade, no_effect, -1, -1, NULL), // Nothing :)

    // Enemy spawn shuffle items
    [0x1025] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9300, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 0, -1, NULL),
    [0x1026] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9301, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 1, -1, NULL),
    [0x1027] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9302, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 2, -1, NULL),
    [0x1028] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9303, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 3, -1, NULL),
    [0x1029] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9304, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 4, -1, NULL),
    [0x102A] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9305, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 5, -1, NULL),
    [0x102B] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9306, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 6, -1, NULL),
    [0x102C] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9307, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 7, -1, NULL),
    [0x102D] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9308, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 8, -1, NULL),
    [0x102E] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9309, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 9, -1, NULL),
    [0x102F] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x930A, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 10, -1, NULL),
    [0x1030] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x930B, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 11, -1, NULL),
    [0x1031] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x930C, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 12, -1, NULL),
    [0x1032] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x930D, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 13, -1, NULL),
    [0x1033] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x930E, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 14, -1, NULL),
    [0x1034] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x930F, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 15, -1, NULL),
    [0x1035] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9310, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 16, -1, NULL),
    [0x1036] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9311, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 17, -1, NULL),
    [0x1037] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9312, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 18, -1, NULL),
    [0x1038] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9313, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 19, -1, NULL),
    [0x1039] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9314, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 20, -1, NULL),
    [0x103A] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9315, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 21, -1, NULL),
    [0x103B] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9316, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 22, -1, NULL),
    [0x103C] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9317, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 23, -1, NULL),
    [0x103D] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9318, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 24, -1, NULL),
    [0x103E] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9319, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 25, -1, NULL),
    [0x103F] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x931A, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 26, -1, NULL),
    [0x1040] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x931B, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 27, -1, NULL),
    [0x1041] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x931C, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 28, -1, NULL),
    [0x1042] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x931D, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 29, -1, NULL),
    [0x1043] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x931E, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 30, -1, NULL),
    [0x1044] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x931F, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 31, -1, NULL),
    [0x1045] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9320, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 32, -1, NULL),
    [0x1046] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9321, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 33, -1, NULL),
    [0x1047] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9322, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 34, -1, NULL),
    [0x1048] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9323, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 35, -1, NULL),
    [0x1049] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9324, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 36, -1, NULL),
    [0x104A] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9325, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 37, -1, NULL),
    [0x104B] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9326, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 38, -1, NULL),
    [0x104C] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9327, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 39, -1, NULL),
    [0x104D] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9328, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 40, -1, NULL),
    [0x104E] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9329, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 41, -1, NULL),
    [0x104F] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x932A, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 42, -1, NULL),
    [0x1050] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x932B, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 43, -1, NULL),
    [0x1051] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x932C, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 44, -1, NULL),
    [0x1052] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x932D, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 45, -1, NULL),
    [0x1053] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x932E, 0x01AB, 0x63, no_upgrade, give_enemy_soul, 46, -1, NULL),
};
