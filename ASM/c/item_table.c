...
item_row_t item_table[] = {
    ...
    [0x0104] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x908B, 0x0193, 0x76, no_upgrade, give_triforce_piece, -1, -1, NULL), // Triforce of Power
    [0x0105] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x908C, 0x0193, 0x76, no_upgrade, give_triforce_piece, -1, -1, NULL), // Triforce of Wisdom
    [0x0106] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x908D, 0x0193, 0x76, no_upgrade, give_triforce_piece, -1, -1, NULL), // Triforce of Courage
};
