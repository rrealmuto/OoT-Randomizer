...
item_row_t item_table[] = {
    ...
    [0x0077] = ITEM_ROW(0x53,       BROWN_CHEST, 0x98, -1, 0x0090, 0x00C7, 0xA0, no_upgrade, no_effect, -1, -1, NULL), // Deku Stick Upgrade (20)
    [0x0078] = ITEM_ROW(0x53,       BROWN_CHEST, 0x99, -1, 0x0091, 0x00C7, 0xA0, no_upgrade, no_effect, -1, -1, NULL), // Deku Stick Upgrade (30)
    [0x0079] = ITEM_ROW(0x53,       BROWN_CHEST, 0x9A, -1, 0x00A7, 0x00BB, 0xA1, no_upgrade, no_effect, -1, -1, NULL), // Deku Nut Upgrade (30)
    [0x007A] = ITEM_ROW(0x53,       BROWN_CHEST, 0x9B, -1, 0x00A8, 0x00BB, 0xA1, no_upgrade, no_effect, -1, -1, NULL), // Deku Nut Upgrade (40)
    ...
    [0x0087] = ITEM_ROW(  -1,       BROWN_CHEST,   -1, -1,     -1, 0x00BB, 0x98, nut_upgrade,       no_effect, -1, -1, NULL), // Progressive Nut Capacity
    [0x0088] = ITEM_ROW(  -1,       BROWN_CHEST,   -1, -1,     -1, 0x00C7, 0x97, stick_upgrade,     no_effect, -1, -1, NULL), // Progressive Stick Capacity
    ...
    [0x2000] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9300, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 0, -1, NULL),
    [0x2001] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9301, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 1, -1, NULL),
    [0x2002] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9302, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 2, -1, NULL),
    [0x2003] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9303, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 3, -1, NULL),
    [0x2004] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9304, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 4, -1, NULL),
    [0x2005] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9305, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 5, -1, NULL),
    [0x2006] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9306, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 6, -1, NULL),
    [0x2007] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9307, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 7, -1, NULL),
    [0x2008] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9308, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 8, -1, NULL),
    [0x2009] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9309, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 9, -1, NULL),
    [0x200A] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x930A, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 10, -1, NULL),
    [0x200B] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x930B, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 11, -1, NULL),
    [0x200C] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x930C, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 12, -1, NULL),
    [0x200D] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x930D, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 13, -1, NULL),
    [0x200E] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x930E, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 14, -1, NULL),
    [0x200F] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x930F, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 15, -1, NULL),
    [0x2010] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9310, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 16, -1, NULL),
    [0x2011] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9311, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 17, -1, NULL),
    [0x2012] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9312, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 18, -1, NULL),
    [0x2013] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9313, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 19, -1, NULL),
    [0x2014] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9314, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 20, -1, NULL),
    [0x2015] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9315, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 21, -1, NULL),
    [0x2016] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9316, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 22, -1, NULL),
    [0x2017] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9317, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 23, -1, NULL),
    [0x2018] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9318, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 24, -1, NULL),
    [0x2019] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9319, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 25, -1, NULL),
    [0x201A] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x931A, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 26, -1, NULL),
    [0x201B] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x931B, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 27, -1, NULL),
    [0x201C] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x931C, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 28, -1, NULL),
    [0x201D] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x931D, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 29, -1, NULL),
    [0x201E] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x931E, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 30, -1, NULL),
    [0x201F] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x931F, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 31, -1, NULL),
    [0x2020] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9320, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 32, -1, NULL),
    [0x2021] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9321, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 33, -1, NULL),
    [0x2022] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9322, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 34, -1, NULL),
    [0x2023] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9323, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 35, -1, NULL),
    [0x2024] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9324, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 36, -1, NULL),
    [0x2025] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9325, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 37, -1, NULL),
    [0x2026] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9326, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 38, -1, NULL),
    [0x2027] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9327, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 39, -1, NULL),
    [0x2028] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9328, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 40, -1, NULL),
    [0x2029] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9329, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 41, -1, NULL),
    [0x202A] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x932A, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 42, -1, NULL),
    [0x202B] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x932B, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 43, -1, NULL),
    [0x202C] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x932C, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 44, -1, NULL),
    [0x202D] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x932D, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 45, -1, NULL),
    [0x202E] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x932E, 0x01B4, 0x63, no_upgrade, give_enemy_soul, 46, -1, NULL),
    [0x202F] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x932F, 0x01B4, 0x63, no_upgrade, give_regional_enemy_soul, 0, -1, NULL),
    [0x2030] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9330, 0x01B4, 0x63, no_upgrade, give_regional_enemy_soul, 1, -1, NULL),
    [0x2031] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9331, 0x01B4, 0x63, no_upgrade, give_regional_enemy_soul, 2, -1, NULL),
    [0x2032] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9332, 0x01B4, 0x63, no_upgrade, give_regional_enemy_soul, 3, -1, NULL),
    [0x2033] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9333, 0x01B4, 0x63, no_upgrade, give_regional_enemy_soul, 4, -1, NULL),
    [0x2034] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9334, 0x01B4, 0x63, no_upgrade, give_regional_enemy_soul, 5, -1, NULL),
    [0x2035] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9335, 0x01B4, 0x63, no_upgrade, give_regional_enemy_soul, 6, -1, NULL),
    [0x2036] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9336, 0x01B4, 0x63, no_upgrade, give_regional_enemy_soul, 7, -1, NULL),
    [0x2037] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9337, 0x01B4, 0x63, no_upgrade, give_regional_enemy_soul, 8, -1, NULL),
    [0x2038] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9338, 0x01B4, 0x63, no_upgrade, give_regional_enemy_soul, 9, -1, NULL),
    [0x2039] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9339, 0x01B4, 0x63, no_upgrade, give_regional_enemy_soul, 10, -1, NULL),
    [0x203A] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x933A, 0x01B4, 0x63, no_upgrade, give_regional_enemy_soul, 11, -1, NULL),
    [0x203B] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x933B, 0x01B4, 0x63, no_upgrade, give_regional_enemy_soul, 12, -1, NULL),
    [0x203C] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x933C, 0x01B4, 0x63, no_upgrade, give_regional_enemy_soul, 13, -1, NULL),
    [0x203D] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x933D, 0x01B4, 0x63, no_upgrade, give_regional_enemy_soul, 14, -1, NULL),
    [0x203E] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x933E, 0x01B4, 0x63, no_upgrade, give_regional_enemy_soul, 15, -1, NULL),
    [0x203F] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x933F, 0x01B4, 0x63, no_upgrade, give_regional_enemy_soul, 16, -1, NULL),
    [0x2040] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9340, 0x01B4, 0x63, no_upgrade, give_regional_enemy_soul, 17, -1, NULL),
    [0x2041] = ITEM_ROW(0x53,        GOLD_CHEST,  0x41, -1, 0x9341, 0x01B4, 0x63, no_upgrade, give_regional_enemy_soul, 18, -1, NULL),
    ...
    [0x2103] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x9503, 0x01B7, 0xA3, no_upgrade, give_fish,        10, 1, NULL), // Fish (child, 10 lb)
    [0x2104] = ITEM_ROW(0x53,      BROWN_CHEST, 0x41, -1, 0x9504, 0x01B7, 0xA3, no_upgrade, give_fish,        10, 0, NULL), // Fish (adult, 10 lb)
    [0x2105] = ITEM_ROW(0x53,      BROWN_CHEST, 0x41, -1, 0x9505, 0x01B7, 0xA3, no_upgrade, give_fish,        12, 0, NULL), // Fish (adult, 12 lb)
    [0x2106] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x9506, 0x01B7, 0xA3, no_upgrade, give_fish,        16, 0, NULL), // Fish (adult, 16 lb)
    [0x2107] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x9507, 0x01B7, 0xA3, no_upgrade, give_fish,        30, 0, NULL), // Hylian Loach
};
