...
item_row_t item_table[] = {
    ...
    [0xED] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9031, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, DODONGO_ID, 0x00, NULL), // Silver Rupee Pouch (Dodongos Cavern Staircase)
    [0xEE] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9032, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, ICE_ID,     0x01, NULL), // Silver Rupee Pouch (Ice Cavern Spinning Scythe)
    [0xEF] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9033, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, ICE_ID,     0x02, NULL), // Silver Rupee Pouch (Ice Cavern Push Block)
    [0xF0] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9034, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, BOTW_ID,    0x03, NULL), // Silver Rupee Pouch (Bottom of the Well Basement)
    [0xF1] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9035, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, SHADOW_ID,  0x04, NULL), // Silver Rupee Pouch (Shadow Temple Scythe Shortcut)
    [0xF2] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9036, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, SHADOW_ID,  0x05, NULL), // Silver Rupee Pouch (Shadow Temple Invisible Blades)
    [0xF3] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9037, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, SHADOW_ID,  0x06, NULL), // Silver Rupee Pouch (Shadow Temple Huge Pit)
    [0xF4] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9038, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, SHADOW_ID,  0x07, NULL), // Silver Rupee Pouch (Shadow Temple Invisible Spikes)
    [0xF5] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9039, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, GTG_ID,     0x08, NULL), // Silver Rupee Pouch (Gerudo Training Ground Slopes)
    [0xF6] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x903A, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, GTG_ID,     0x09, NULL), // Silver Rupee Pouch (Gerudo Training Ground Lava)
    [0xF7] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x903B, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, GTG_ID,     0x0A, NULL), // Silver Rupee Pouch (Gerudo Training Ground Water)
    [0xF8] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x903C, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, SPIRIT_ID,  0x0B, NULL), // Silver Rupee Pouch (Spirit Temple Child Early Torches)
    [0xF9] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x903D, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, SPIRIT_ID,  0x0C, NULL), // Silver Rupee Pouch (Spirit Temple Adult Boulders)
    [0xFA] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x903E, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, SPIRIT_ID,  0x0D, NULL), // Silver Rupee Pouch (Spirit Temple Lobby and Lower Adult)
    [0xFB] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x903F, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, SPIRIT_ID,  0x0E, NULL), // Silver Rupee Pouch (Spirit Temple Sun Block)
    [0xFC] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9040, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, SPIRIT_ID,  0x0F, NULL), // Silver Rupee Pouch (Spirit Temple Adult Climb)
    [0xFD] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9041, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, CASTLE_ID,  0x10, NULL), // Silver Rupee Pouch (Ganons Castle Spirit Trial)
    [0xFE] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9042, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, CASTLE_ID,  0x11, NULL), // Silver Rupee Pouch (Ganons Castle Light Trial)
    [0xFF] = ITEM_ROW(0x4D,      SILVER_CHEST, 0x86, -1, 0x9043, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, CASTLE_ID,  0x12, NULL), // Silver Rupee Pouch (Ganons Castle Fire Trial)
    [0x100] = ITEM_ROW(0x4D,     SILVER_CHEST, 0x86, -1, 0x9044, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, CASTLE_ID,  0x13, NULL), // Silver Rupee Pouch (Ganons Castle Shadow Trial)
    [0x101] = ITEM_ROW(0x4D,     SILVER_CHEST, 0x86, -1, 0x9045, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, CASTLE_ID,  0x14, NULL), // Silver Rupee Pouch (Ganons Castle Water Trial)
    [0x102] = ITEM_ROW(0x4D,     SILVER_CHEST, 0x86, -1, 0x9046, 0x0197, 0x72, no_upgrade, give_silver_rupee_pouch, CASTLE_ID,  0x15, NULL), // Silver Rupee Pouch (Ganons Castle Forest Trial)
};
