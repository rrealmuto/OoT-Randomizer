...
item_row_t item_table[] = {
    ...
    [0x00D7] = ITEM_ROW(0x53,      SILVER_CHEST, 0x41, -1, 0x9210, 0x0195, 0x77, no_upgrade, give_small_key_ring, TCG_ID, -1, NULL), // Treasure Chest Game Small Key Ring
    ...
    [0x010B] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x0082, 0x019E, 0x8D, no_upgrade, give_quest_item, 20, -1, NULL), // Zora Sapphire
    [0x010C] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x0040, 0x019F, 0x85, no_upgrade, give_quest_item, 5,  -1, NULL), // Light Medallion
    [0x010D] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x003E, 0x01A0, 0x86, no_upgrade, give_quest_item, 0,  -1, NULL), // Forest Medallion
    [0x010E] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x003C, 0x01A1, 0x87, no_upgrade, give_quest_item, 1,  -1, NULL), // Fire Medallion
    [0x010F] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x003D, 0x01A2, 0x88, no_upgrade, give_quest_item, 2,  -1, NULL), // Water Medallion
    [0x0110] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x0041, 0x01A3, 0x89, no_upgrade, give_quest_item, 4,  -1, NULL), // Shadow Medallion
    [0x0111] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x003F, 0x01A4, 0x8A, no_upgrade, give_quest_item, 3,  -1, NULL), // Spirit Medallion

    [0x0112] = ITEM_ROW(0x5B,   SKULL_CHEST_BIG, 0x71, -1, 0x00B4, 0x015C, 0x63, no_upgrade,         no_effect,           -1, -1, NULL), // Gold Skulltula Token (big chest)
    [0x0113] = ITEM_ROW(0x3D,   HEART_CHEST_BIG, 0x72, -1, 0x00C6, 0x00BD, 0x13, health_upgrade_cap, clear_excess_hearts, -1, -1, NULL), // Heart Container (big chest)
    [0x0114] = ITEM_ROW(0x3E,   HEART_CHEST_BIG, 0x7A, -1, 0x00C2, 0x00BD, 0x14, health_upgrade_cap, full_heal,           -1, -1, NULL), // Piece of Heart (big chest)
    [0x0115] = ITEM_ROW(0x53,   HEART_CHEST_BIG, 0x7A, -1, 0x00FA, 0x00BD, 0x14, health_upgrade_cap, full_heal,           -1, -1, NULL), // Piece of Heart (Chest Game) (big chest)
    [0x0116] = ITEM_ROW(0x53,      GILDED_CHEST, 0x3E, -1, 0x004C, 0x00CB, 0x1D, no_upgrade,         no_effect,           -1, -1, NULL), // Deku Shield (big chest)
    [0x0117] = ITEM_ROW(0x53,      GILDED_CHEST, 0x3F, -1, 0x004D, 0x00DC, 0x2C, no_upgrade,         no_effect,           -1, -1, NULL), // Hylian Shield (big chest)
    [0x0118] = ITEM_ROW(0x4D,      GILDED_CHEST, 0x96, -1, 0x0033, 0x00D9, 0x28, no_upgrade,         no_effect,           -1, -1, NULL), // Bombchu (5) (big chest)
    [0x0119] = ITEM_ROW(0x4D,      GILDED_CHEST, 0x09, -1, 0x0033, 0x00D9, 0x28, no_upgrade,         no_effect,           -1, -1, NULL), // Bombchu (10) (big chest)
    [0x011A] = ITEM_ROW(0x4D,      GILDED_CHEST, 0x97, -1, 0x0033, 0x00D9, 0x28, no_upgrade,         no_effect,           -1, -1, NULL), // Bombchu (20) (big chest)
    ...
    [0x0121] = ITEM_ROW(0x53,      SILVER_CHEST, 0x41, -1, 0x9213, 0x0195, 0x77, no_upgrade, give_keyring_with_bk, WATER_ID,  -1, NULL), // Water Temple Key Ring (with boss key)
    ...
    [0x1003] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x9057, 0x01A8, 0x29, no_upgrade, give_triforce_piece, -1, -1, NULL), // Easter egg (blue)
