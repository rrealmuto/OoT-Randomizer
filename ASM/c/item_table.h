...
typedef enum GetItemID {
    ...
    GI_SOUL_TEKTITE,
    GI_SOUL_PEAHAT,
    GI_SOUL_LIZALFOS_AND_DINALFOS,
    GI_SOUL_GOHMA_LARVAE,
    GI_SOUL_SHABOM,
    GI_SOUL_BABY_DODONGO,
    GI_SOUL_BIRI_AND_BARI,
    GI_SOUL_TAILPASARAN,
    GI_SOUL_SKULLTULA,
    GI_SOUL_TORCH_SLUG,
    GI_SOUL_MOBLIN,
    ...
    GI_SOUL_BEAMOS,
    GI_SOUL_FLOORMASTER,
    GI_SOUL_REDEAD_AND_GIBDO,
    GI_SOUL_SKULLWALLTULA,
    ...
    GI_SOUL_BONGO_BONGO,
    GI_SOUL_TWINROVA,
    GI_SOUL_JABU_JABU_TENTACLE,
    GI_SOUL_DARK_LINK,

    GI_SOUL_REGIONAL_DEKU_TREE,
    GI_SOUL_REGIONAL_DODONGOS_CAVERN,
    GI_SOUL_REGIONAL_JABU,
    GI_SOUL_REGIONAL_FOREST_TEMPLE,
    GI_SOUL_REGIONAL_FIRE_TEMPLE,
    GI_SOUL_REGIONAL_WATER_TEMPLE,
    GI_SOUL_REGIONAL_SHADOW_TEMPLE,
    GI_SOUL_REGIONAL_SPIRIT_TEMPLE,
    GI_SOUL_REGIONAL_BOTW,
    GI_SOUL_REGIONAL_ICE_CAVERN,
    GI_SOUL_REGIONAL_GTG,
    GI_SOUL_REGIONAL_GANONS_CASTLE,
    GI_SOUL_REGIONAL_FOREST_AREA,
    GI_SOUL_REGIONAL_HYRULE_FIELD,
    GI_SOUL_REGIONAL_LAKE_HYLIA,
    GI_SOUL_REGIONAL_GERUDO_AREA,
    GI_SOUL_REGIONAL_MARKET_AREA,
    GI_SOUL_REGIONAL_KAKARIKO_AREA,
    GI_SOUL_REGIONAL_GORON_AREA,
    GI_SOUL_REGIONAL_ZORA_AREA,
...
_Static_assert(GI_RANDO_MAX == 0x017D, "Remember to update the comment and the assert for the value of GI_RANDO_MAX when adding new items");
