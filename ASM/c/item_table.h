...
typedef enum GetItemID {
    ...
    // Soul Shuffle GI IDs
    /* 0x0130 */ GI_SOUL_STALFOS = 0x0200,
    /* 0x0131 */ GI_SOUL_OCTOROK,
    /* 0x0132 */ GI_SOUL_WALLMASTER,
    /* 0x0133 */ GI_SOUL_DODONGO,
    /* 0x0134 */ GI_SOUL_KEESE,
    /* 0x0135 */ GI_SOUL_TEKTITE,
    /* 0x0136 */ GI_SOUL_PEAHAT,
    /* 0x0137 */ GI_SOUL_LIZALFOS_AND_DINALFOS,
    /* 0x0138 */ GI_SOUL_GOHMA_LARVAE,
    /* 0x0139 */ GI_SOUL_SHABOM,
    /* 0x013A */ GI_SOUL_BABY_DODONGO,
    /* 0x013B */ GI_SOUL_BIRI_AND_BARI,
    /* 0x013C */ GI_SOUL_TAILPASARAN,
    /* 0x013D */ GI_SOUL_SKULLTULA,
    /* 0x013E */ GI_SOUL_TORCH_SLUG,
    /* 0x013F */ GI_SOUL_MOBLIN,
    /* 0x0140 */ GI_SOUL_ARMOS,
    /* 0x0141 */ GI_SOUL_DEKU_BABA,
    /* 0x0142 */ GI_SOUL_DEKU_SCRUB,
    /* 0x0143 */ GI_SOUL_BUBBLE,
    /* 0x0144 */ GI_SOUL_BEAMOS,
    /* 0x0145 */ GI_SOUL_FLOORMASTER,
    /* 0x0146 */ GI_SOUL_REDEAD_AND_GIBDO,
    /* 0x0147 */ GI_SOUL_SKULLWALLTULA,
    /* 0x0148 */ GI_SOUL_FLARE_DANCER,
    /* 0x0149 */ GI_SOUL_DEAD_HAND,
    /* 0x014A */ GI_SOUL_SHELL_BLADE,
    /* 0x014B */ GI_SOUL_LIKE_LIKE,
    /* 0x014C */ GI_SOUL_SPIKE_ENEMY,
    /* 0x014D */ GI_SOUL_ANUBIS,
    /* 0x014E */ GI_SOUL_IRON_KNUCKLE,
    /* 0x014F */ GI_SOUL_SKULL_KID,
    /* 0x0150 */ GI_SOUL_FLYING_POT,
    /* 0x0151 */ GI_SOUL_FREEZARD,
    /* 0x0152 */ GI_SOUL_STINGER,
    /* 0x0153 */ GI_SOUL_WOLFOS,
    /* 0x0154 */ GI_SOUL_GUAY,
    /* 0x0155 */ GI_SOUL_QUEEN_GOHMA,
    /* 0x0156 */ GI_SOUL_KING_DODONGO,
    /* 0x0157 */ GI_SOUL_BARINADE,
    /* 0x0158 */ GI_SOUL_PHANTOM_GANON,
    /* 0x0159 */ GI_SOUL_VOLVAGIA,
    /* 0x015A */ GI_SOUL_MORPHA,
    /* 0x015B */ GI_SOUL_BONGO_BONGO,
    /* 0x015C */ GI_SOUL_TWINROVA,
    /* 0x015D */ GI_SOUL_JABU_JABU_TENTACLE,
    /* 0x015E */ GI_SOUL_DARK_LINK,

    /* 0x015F */ GI_SOUL_REGIONAL_DEKU_TREE,
    /* 0x0160 */ GI_SOUL_REGIONAL_DODONGOS_CAVERN,
    /* 0x0161 */ GI_SOUL_REGIONAL_JABU,
    /* 0x0162 */ GI_SOUL_REGIONAL_FOREST_TEMPLE,
    /* 0x0163 */ GI_SOUL_REGIONAL_FIRE_TEMPLE,
    /* 0x0164 */ GI_SOUL_REGIONAL_WATER_TEMPLE,
    /* 0x0165 */ GI_SOUL_REGIONAL_SHADOW_TEMPLE,
    /* 0x0166 */ GI_SOUL_REGIONAL_SPIRIT_TEMPLE,
    /* 0x0167 */ GI_SOUL_REGIONAL_BOTW,
    /* 0x0168 */ GI_SOUL_REGIONAL_ICE_CAVERN,
    /* 0x0169 */ GI_SOUL_REGIONAL_GTG,
    /* 0x016A */ GI_SOUL_REGIONAL_GANONS_CASTLE,
    /* 0x016B */ GI_SOUL_REGIONAL_FOREST_AREA,
    /* 0x016C */ GI_SOUL_REGIONAL_HYRULE_FIELD,
    /* 0x016D */ GI_SOUL_REGIONAL_LAKE_HYLIA,
    /* 0x016E */ GI_SOUL_REGIONAL_GERUDO_AREA,
    /* 0x016F */ GI_SOUL_REGIONAL_MARKET_AREA,
    /* 0x0170 */ GI_SOUL_REGIONAL_KAKARIKO_AREA,
    /* 0x0171 */ GI_SOUL_REGIONAL_GORON_AREA,
    /* 0x0172 */ GI_SOUL_REGIONAL_ZORA_AREA,
