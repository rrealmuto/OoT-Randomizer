...
.org 0x80957bf4
nop
.org 0x80957ba4 ; Reloc 0x1A04
ENFD_PATCH_RELOC_1A04_START:
nop
ENFD_PATCH_RELOC_1A04_END:
.org 0x80957b18 ; Reloc 0x155C
ENFD_PATCH_RELOC_155C_START:
nop
ENFD_PATCH_RELOC_155C_END:
