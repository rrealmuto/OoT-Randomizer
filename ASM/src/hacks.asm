...
; Hack for enemy drop shuffle to display enemy markers on the minimap
.headersize (0x800110A0 - 0xA87000)
; Hack at call to Minimap_Draw in Interface_Draw
.org 0x80075D48
; Replaces
;   jal     0x8006CA64
...
.include "hacks/hack_ageless_hookshot.asm"
