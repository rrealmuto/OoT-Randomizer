...
ITEM_MESSAGES: list[tuple[int, str]] = [
    ...
    (0x930B, "\x08You found the \x05\x41Biri Souls!"),
    ...
    (0x9313, "\x08You found the \x05\x41Bari Souls!"),
    (0x9314, "\x08You found the \x05\x41Bubble Souls!"),
    (0x9315, "\x08You found the \x05\x41Beamos Souls!"),
    (0x9316, "\x08You found the \x05\x41Floormaster Souls!"),
    (0x9317, "\x08You found the \x05\x41Redead and Gibdo Souls!"),
    (0x9318, "\x08You found the \x05\x41Skullwalltula Souls!"),
    (0x9319, "\x08You found the \x05\x41Flare Dancer Souls!"),
    (0x931A, "\x08You found the \x05\x41Dead hand? Souls!"),
    (0x931B, "\x08You found the \x05\x41Shell blade Souls!"),
    (0x931C, "\x08You found the \x05\x41Like-like Souls!"),
    (0x931D, "\x08You found the \x05\x41Spike Enemy Souls!"),
    (0x931E, "\x08You found the \x05\x41Anubis Souls!"),
    (0x931F, "\x08You found the \x05\x41Iron Knuckle Souls!"),
    (0x9320, "\x08You found the \x05\x41Skull Kid Souls!"),
    (0x9321, "\x08You found the \x05\x41Flying Pot Souls!"),
    (0x9322, "\x08You found the \x05\x41Freezard Souls!"),
    (0x9323, "\x08You found the \x05\x41Stinger Souls!"),
    (0x9324, "\x08You found the \x05\x41Wolfos Souls!"),
    (0x9325, "\x08You found the \x05\x41Guay Souls!"),
