...
KEYSANITY_MESSAGES = [
    ...
    (0x9034, "\x08You have found all of the \x05\x44Silver\x01Rupees\x05\x40 for the basement in the\x01\x05EBottom of the Well\x05\x40!\x09"),
    (0x9035, "\x08You have found all of the \x05\x44Silver\x01Rupees\x05\x40 for the \x05\x42scythe shortcut room\x05\x40\x01in the \x05EShadow Temple\x05\x40!\x09"),
    ...
    (0x9037, "\x08You have found all of the \x05\x44Silver\x01Rupees\x05\x40 for the \x05\x46huge pit\x05\x40 in the\x01\x05EShadow Temple\x05\x40!\x09"),
    (0x9038, "\x08You have found all of the \x05\x44Silver\x01Rupees\x05\x40 for the room with \x05Einvisible\x01spikes\x05\x40 in the \x05EShadow Temple\x05\x40!\x09"),
    ...
    (0x904E, "\x08You have found all of the \x05\x44Silver\x01Rupees\x05\x40 for the \x05\x44invisible blade room\x05\x40 in\x01the \x05\x45Shadow Temple\x05\x40! Now you can\x01access the \x05\x4chest\x05\x40 there!\x09"),
    ...
    (0x9051, "\x08You have found all of the \x05\x44Silver\x01Rupees\x05\x40 for the \x05\x46sloped room\x05\x40in the\x01\x05\x46Gerudo Training Ground\x05\x40! The way to\x01the room wih the \x05\x46heavy block\x05\x40 is\x04open!\x09"),
    ...
    (0x9062, "\x08You have found all of the \x05\x44Silver\x01Rupees\x05\x40 for the basement in the\x01\x05EBottom of the Well\x05\x40! Now you can\x01get back to the upper level!\x09"),
    (0x9063, "\x08You have found all of the \x05\x44Silver\x01Rupees\x05\x40 for the \x05\x42scythe shortcut room\x05\x40\x01in the \x05EShadow Temple\x05\x40! Now you can\x01access the \x05\x42chest\x05\x40 there!\x09"),
    # 0x9064 unused
    (0x9065, "\x08You have found all of the \x05\x44Silver\x01Rupees\x05\x40 for the \x05\x46huge pit\x05\x40 in the\x01\x05EShadow Temple\x05\x40! The way to the\x01room with \x05\x46falling spikes\x05\x40 is open!\x09"),
    (0x9066, "\x08You have found all of the \x05\x44Silver\x01Rupees\x05\x40 for the room with \x05Einvisible\x01spikes\x05\x40 in the \x05EShadow Temple\x05\x40! The\x01way to the room with the \x05Egiant pot\x05\x40\x04is open!\x09"),
