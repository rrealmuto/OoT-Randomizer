...
ITEM_MESSAGES: list[tuple[int, str]] = [
    ...
    (0x9300, "\x08You found the \x05\x41Stalfos Souls!"),
    (0x9301, "\x08You found the \x05\x41Octorok Souls!"),
    (0x9302, "\x08You found the \x05\x41Wallmaster Souls!"),
    (0x9303, "\x08You found the \x05\x41Dodongo Souls!"),
    (0x9304, "\x08You found the \x05\x41Keese Souls!"),
    (0x9305, "\x08You found the \x05\x41Tektite Souls!"),
    (0x9306, "\x08You found the \x05\x41Peahat Souls!"),
    (0x9307, "\x08You found the \x05\x41Lizalfos and Dinalfos Souls!"),
    (0x9308, "\x08You found the \x05\x41Gohma Larvae Souls!"),
    (0x9309, "\x08You found the \x05\x41Shabom Souls!"),
    (0x930A, "\x08You found the \x05\x41Baby Dodongo Souls!"),
    (0x930B, "\x08You found the \x05\x41Biri and Bari Souls!"),
    (0x930C, "\x08You found the \x05\x41Tailpasaran Souls!"),
    (0x930D, "\x08You found the \x05\x41Skulltula Souls!"),
    (0x930E, "\x08You found the \x05\x41Torch Slug Souls!"),
    (0x930F, "\x08You found the \x05\x41Moblin Souls!"),
    (0x9310, "\x08You found the \x05\x41Armos Souls!"),
    (0x9311, "\x08You found the \x05\x41Deku Baba Souls!"),
    (0x9312, "\x08You found the \x05\x41Deku Scrub Souls!"),
    (0x9313, "\x08You found the \x05\x41Bubble Souls!"),
    (0x9314, "\x08You found the \x05\x41Beamos Souls!"),
    (0x9315, "\x08You found the \x05\x41Floormaster Souls!"),
    (0x9316, "\x08You found the \x05\x41Redead and Gibdo Souls!"),
    (0x9317, "\x08You found the \x05\x41Skullwalltula Souls!"),
    (0x9318, "\x08You found the \x05\x41Flare Dancer Souls!"),
    (0x9319, "\x08You found the \x05\x41Dead hand Souls!"),
    (0x931A, "\x08You found the \x05\x41Shell blade Souls!"),
    (0x931B, "\x08You found the \x05\x41Like-like Souls!"),
    (0x931C, "\x08You found the \x05\x41Spike Enemy Souls!"),
    (0x931D, "\x08You found the \x05\x41Anubis Souls!"),
    (0x931E, "\x08You found the \x05\x41Iron Knuckle Souls!"),
    (0x931F, "\x08You found the \x05\x41Skull Kid Souls!"),
    (0x9320, "\x08You found the \x05\x41Flying Pot Souls!"),
    (0x9321, "\x08You found the \x05\x41Freezard Souls!"),
    (0x9322, "\x08You found the \x05\x41Stinger Souls!"),
    (0x9323, "\x08You found the \x05\x41Wolfos Souls!"),
    (0x9324, "\x08You found the \x05\x41Guay Souls!"),
    (0x9325, "\x08You found the \x05\x41Queen Gohma Souls!"),
    (0x9326, "\x08You found the \x05\x41King Dodongo Souls!"),
    (0x9327, "\x08You found the \x05\x41Barinade Souls!"),
    (0x9328, "\x08You found the \x05\x41Phantom Ganon Souls!"),
    (0x9329, "\x08You found the \x05\x41Volvagia Souls!"),
    (0x932A, "\x08You found the \x05\x41Morpha Souls!"),
...
KEYSANITY_MESSAGES: list[tuple[int, str]] = [
    ...
    (0x9039, "\x08You have found all of the \x05\x44Silver\x01Rupees\x05\x40 for the \x05\x46sloped room\x05\x40in the\x01\x05\x46Gerudo Training Ground\x05\x40!\x09"),
    ...
    (0x9051, "\x08You have found all of the \x05\x44Silver\x01Rupees\x05\x40 for the \x05\x46sloped room\x05\x40in the\x01\x05\x46Gerudo Training Ground\x05\x40! The way to\x01the room with the \x05\x46heavy block\x05\x40 is\x04open!\x09"),
    ...
    (0x9067, "\x08You have found all of the \x05\x44Silver\x01Rupees\x05\x40 for the \x05\x46sloped room\x05\x40in the\x01\x05\x46Gerudo Training Ground\x05\x40! The way to\x01the room with the \x05\x46heavy block\x05\x40 is\x04open!\x09"),
