...
ITEM_MESSAGES = [
    ...
    (0x9090, "\x08\x06\x28You have learned the\x01\x06\x2F\x05\x42Minuet of Forest\x05\x40!"),
    (0x9091, "\x08\x06\x28You have learned the\x01\x06\x37\x05\x41Bolero of Fire\x05\x40!"),
    (0x9092, "\x08\x06\x28You have learned the\x01\x06\x29\x05\x43Serenade of Water\x05\x40!"),
    (0x9093, "\x08\x06\x28You have learned the\x01\x06\x2D\x05\x46Requiem of Spirit\x05\x40!"),
    (0x9094, "\x08\x06\x28You have learned the\x01\x06\x28\x05\x45Nocturne of Shadow\x05\x40!"),
    (0x9095, "\x08\x06\x28You have learned the\x01\x06\x32\x05\x44Prelude of Light\x05\x40!"),
    # 0x9096 through 0x9098 unused
    # 0x9099 used above
