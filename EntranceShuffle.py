    ...
    for world in worlds:
        ...
        for pool_type, entrance_pool in one_way_entrance_pools.items():
            ...
            if pool_type == 'OwlDrop':
                valid_target_types = ('WarpSong', 'BlueWarp', 'OwlDrop', 'Overworld', 'Extra')
                ...
                valid_target_types = ('Spawn', 'WarpSong', 'BlueWarp', 'OwlDrop', 'Overworld', 'Interior', 'SpecialInterior', 'Extra')
...
def get_entrance_replacing(region, entrance_name):
    ...
    try:
        return next(filter(lambda entrance: entrance.replaces and entrance.replaces.name == entrance_name and \
                                            ...
                                            entrance.type not in ('OwlDrop', 'Spawn', 'WarpSong', 'BlueWarp'), region.entrances))
