...
from ItemPool import item_groups, get_junk_item, song_list, trade_items, child_trade_items, ocarina_buttons, enemy_souls_bosses, enemy_souls_core
...
class WorldDistribution:
    ...
    def to_json(self) -> dict[str, Any]:
        return {
            ...
            'enemies': {str(enemy): self.shuffled_enemies[enemy][0].name for enemy in self.shuffled_enemies}
        }
