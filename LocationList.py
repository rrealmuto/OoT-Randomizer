...
location_table: dict[str, tuple[str, Optional[int], LocationDefault, LocationAddresses, Optional[str], LocationFilterTags]] = OrderedDict([
    ...
    ("Lake Hylia Child Scarecrow Grass 2",                 ("Grass",      0x57,    (0,0,27), None,                                  'Rupees (5)',         ("Lake Hylia", "Grass",))),
    ("Lake Hylia Child Scarecrow Grass 3",                 ("Grass",      0x57,    (0,0,28), None,                                  'Rupees (5)',         ("Lake Hylia", "Grass",))),
    ("Lake Hylia Child Scarecrow Grass 4",                 ("Grass",      0x57,    (0,0,29), None,                                  'Rupees (5)',         ("Lake Hylia", "Grass",))),
    ("Lake Hylia Child Scarecrow Grass 5",                 ("Grass",      0x57,    (0,0,30), None,                                  'Rupees (5)',         ("Lake Hylia", "Grass",))),
