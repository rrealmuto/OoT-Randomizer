...
#    ("Dodongos Cavern Last Block Pot 4",                             ("Collectable",  0x01,  0x21, None,                        'Rupee (1)',                           ("Dodongo's Cavern", "Vanilla", "Pot"))),
    ...
    ("Fire Temple MQ Before Boss Left Crate 1",                      ("Collectable",  0x04,  0x40, ([0x2317bf8],None),          'Rupee (1)',                             ("Fire Temple", "Master Quest", "Crate"))),
    ("Fire Temple MQ Before Boss Left Crate 2",                      ("Collectable",  0x04,  0x41, ([0x2317be8],None),          'Rupee (1)',                             ("Fire Temple", "Master Quest", "Crate"))),
    ("Fire Temple MQ Before Boss Right Lower Crate 1",               ("Collectable",  0x04,  0x42, ([0x2317bc8],None),          'Rupee (1)',                             ("Fire Temple", "Master Quest", "Crate"))),
    ("Fire Temple MQ Before Boss Right Lower Crate 2",               ("Collectable",  0x04,  0x43, ([0x2317bb8],None),          'Rupee (1)',                             ("Fire Temple", "Master Quest", "Crate"))),
    ("Fire Temple MQ Before Boss Right Mid Crate",                   ("Collectable",  0x04,  0x44, ([0x2317bd8],None),          'Rupee (1)',                             ("Fire Temple", "Master Quest", "Crate"))),
    ("Fire Temple MQ Before Boss Right Upper Crate",                 ("Collectable",  0x04,  0x45, ([0x2317c08],None),          'Rupee (1)',                             ("Fire Temple", "Master Quest", "Crate"))),
