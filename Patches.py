...
def patch_rom(spoiler:Spoiler, world:World, rom:Rom):
    ...
    # Initial Save Data
    if not world.settings.useful_cutscenes and not world.settings.dungeon_shortcuts:
    ...
    if world.settings.dungeon_shortcuts:
        ...
        save_context.write_permanent_flag(Scenes.DODONGOS_CAVERN, FlagType.SWITCH, 0x3, 0x02) # DC Boss Floor
