...
class SaveContext:
    ...
    def get_save_context_addresses() -> AddressesDict:
        return {
            ...
            'enemy_spawn_flags': {
                ...
                'lizalfos_and_dinolfos': Address(extended=True, size=1, mask=0x80),
                ...
                'like_like': Address(extended=True, size=1, mask=0x08, pass_addr=True),
    ...
    save_writes_table: dict[str, dict[str, Any]] = {
        ...
        'Lizalfos and Dinolfos Soul': {'enemy_spawn_flags.lizalfos_and_dinolfos': None},
        ...
        'Like Like Soul': {'enemy_spawn_flags.like_like': None},
