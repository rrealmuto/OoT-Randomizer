...
hintTable = {
    ...
    'Triforce of Power':                                        (["a red triangle"], "the Triforce of Power", 'item'),
    'Triforce of Wisdom':                                       (["a blue triangle"], "the Triforce of Wisdom", 'item'),
    'Triforce of Courage':                                      (["a green triangle"], "the Triforce of Courage", 'item'),
