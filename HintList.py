...
hintTable = {
    ...
    'Silver Rupee (Shadow Temple Huge Pit)' :                   (["a Silver Rupee"], "a Silver Rupee", 'item'),
    'Silver Rupee (Shadow Temple Spinner Room)' :               (["a Silver Rupee"], "a Silver Rupee", 'item'),
    'Silver Rupee (Shadow Temple Invisible Spikes)' :           (["a Silver Rupee"], "a Silver Rupee", 'item'),
    'Silver Rupee (Ice Cavern Spinning Blade)' :                (["a Silver Rupee"], "a Silver Rupee", 'item'),
    'Silver Rupee (Ice Cavern Block Push)' :                    (["a Silver Rupee"], "a Silver Rupee", 'item'),
    'Silver Rupee (GTG Lava Room)' :                            (["a Silver Rupee"], "a Silver Rupee", 'item'),
    'Silver Rupee (GTG Underwater)' :                           (["a Silver Rupee"], "a Silver Rupee", 'item'),
    'Silver Rupee (GTG Boulder Room)' :                           (["a Silver Rupee"], "a Silver Rupee", 'item'),
